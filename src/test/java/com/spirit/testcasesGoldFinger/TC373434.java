...
//**********************************************************************************************
//Test Case ID: TC373434
//Description: Task 27822: TC373434- 015 - CP - Room Rate - Flight + Car + Hotel - Validate Room Rates for a booking with an International Origin
// Created By: Gabriela
...
public class TC373434 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath", "RoundTrip", "DomesticDomestic","FlightHotelCar", "Outside21Days", "Adult", "Guest", "FlightAvailabilityUI","HotelsUI"})
    public void CP_Room_Rate_Flight_Car_Hotel_Validate_Room_Rates_for_a_booking_with_an_International_Origin(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC373434 under GoldFinger Suite on " + platform + " Browser", true);
        }
...
//- Step 2: Create Vacation booking F+H+ C 3 ADT INT - DOM 2 roomS - drivers age 25+
