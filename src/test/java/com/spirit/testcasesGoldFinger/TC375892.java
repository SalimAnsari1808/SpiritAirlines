...
//**********************************************************************************************
//Test Case ID: TC375892
//Description : Task:27880 | TC375892 - US 21915 - 010 - CP - Verbiage Car Driver Below 25 - Flight + Hotel + Car - Dollar
//Created By  : Anthony Cardona
//Created On  : 20-Nov-2019
//Reviewed By : Gabriela
//Reviewed On : 5-Dec-2019
//**********************************************************************************************
public class TC375892 extends BaseClass {
    @Parameters({"platform"})
    ...
    public void Verbiage_Car_Driver_Below_25_Flight_Hotel_Car_Dollar(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC375892 under GoldFinger Suite on " + platform + " Browser", true);
        }
...
//Step 3: Select "VIEW" in the box of a Hotel you want
