...
//**********************************************************************************************
//Test CaseID: TC373339
//Title      : Task 27985: TC373339 - 005 - CP - Car Verbiage - Thrifty- Flight + Hotel + Car - Validate verbiage for a booking with an International Origin
...
public class TC373339 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath","RoundTrip","FlightHotelCar","Guest","InternationalDomestic","Outside21Days","Adult","CarsUI"})
    public void CP_Car_Verbiage_Thrifty_Flight_Hotel_Car_Validate_verbiage_for_a_booking_with_and_International_Origin(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC373339 under GoldFinger Suite on " + platform + " Browser", true);
        }
