...
//**********************************************************************************************
//Test CaseID: TC373223
//Title      : 002 - CP - Car Verbiage - National - Flight + Hotel + Car - Validate correct verbiage displays
...
public class TC373223 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath", "RoundTrip", "FlightHotelCar", "DomesticDomestic","Outside21Days","Guest","CarsUI"})
    public void CP_Car_Verbiage_National_Flight_Hotel_Car_Validate_correct_verbiage_displays(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC373223 under GoldFinger Suite on " + platform + " Browser", true);
        }
