...
//Description: Task: 27938 | TC373902 - US 17576 - 005 - CP - Vacation Hotel - Flight + Hotel + Car - Validate Facade and page format for Cars on a booking with an International Destination
//Created By: Anthony Cardona
//Created On: 01-Dec-2019
//Reviewed By:
//Reviewed On:
//**********************************************************************************************
public class TC373902 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"BookPath", "FlightHotelCar", "DomesticInternational", "Outside21Days", "Adult", "Guest" , "NoBags" , "NoSeats" , "CarsUI", "FlightAvailabilityUI"})
    public void Vacation_Hotel_Flight_Hotel_Car_Validate_Facade_and_page_format_for_Cars_on_a_booking_with_an_International_Destination(@Optional("NA")String platform) {
        ...
        final String HOTEL_SEARCH_NAME  = "Bahia Principe";
        final String HOTEL_BOOK_NAME    = "Bahia Principe";
