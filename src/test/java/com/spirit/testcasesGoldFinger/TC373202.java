...
public class TC373202 extends BaseClass {
    @Parameters({"platform"})
    ...
    public void CP_Car_Verbiage_Enterprise_Flight_Car_Validate_correct_verbiage_displays(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC373202 under GoldFinger Suite on " + platform + " Browser", true);
        }
