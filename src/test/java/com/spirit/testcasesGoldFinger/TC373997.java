...
//Reviewed On:
//**********************************************************************************************
public class TC373997 extends BaseClass {
    @Parameters({"platform"})
    ...
    public void CP_Price_Display_Shopping_Cart_Hub_Packaging_Remove_Car_from_reservation_on_Car_upsell(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC373997 under GoldFinger Suite on " + platform + " Browser", true);
        }
