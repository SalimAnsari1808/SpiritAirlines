...
//**********************************************************************************************
//Test Case ID:TC373822
//Description: TC373822 - 006 - CP - Verbiage Car Driver Below 21 - Flight + Hotel + Car - Thrifty
//Created By: Alex Rodriguez
//Created On: 25-Nov-2019
//Reviewed By: Gabriela
//Reviewed On: 4-Dec-2019
//*********************************************************************************************
public class TC373822 extends BaseClass {
@Parameters({"platform"})
@Test(groups = {"BookPath", "RoundTrip", "FlightHotelCar", "Guest", "DomesticDomestic", "Outside21Days", "Adult","Child", "BookIt", "MandatoryFields", "PassengerInformationUI"})
public void CP_Verbiage_Car_Driver_Below_21_Flight_Hotel_Car_Thrifty(@Optional("NA") String platform) {

  //Mention Suite and Browser in reports
  if (!platform.equals("NA")) {
    ValidationUtil.validateTestStep("Starting Test Case ID TC373822 under GoldFinger Suite on " + platform + " Browser", true);
  }
...
//  Step 2	Create a vacation booking flight + hotel + car | Any date outside 48h | 3 ADT 3 CHD | Drivers age 21 - 24 | 1 Room Select "SEARCH VACATION"
...
//  Step 7	Select "BOOK CAR" in the box for a Thrifty car
...
//  Step 9	Input all Adult passengers DOB less than 21 years old and verify that the drop down will not pull a driver.
  ...
  pageObjectManager.getPassengerInfoPage().getAdultDOBListTextBox().get(1).sendKeys(DOB20YearOld);
  pageObjectManager.getPassengerInfoPage().getAdultDOBListTextBox().get(2).sendKeys(DOB20YearOld);
