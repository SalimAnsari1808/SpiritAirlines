...
//**********************************************************************************************
//Test Case ID: TC373744
//Description: Email Confirmation - Hotel + Car Upsell - Validate the proper email is sent for a Standard Booking
//Created By: Salim Ansari
//Created On: 02-Dec-2019
//Reviewed By:
//Reviewed On:
//**********************************************************************************************
public class TC373744 extends BaseClass {
    ...
    public void Email_Confirmation_Car_Upsell_Validate_the_proper_email_is_sent_for_an_Active_Duty_Military_Passenger(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC373744 under GoldFinger Suite on " + platform + " Browser", true);
        }
...
//- Step 2: Create a regular booking for 1 Adt age 18 or over year old, DOM ( to any city different than MCO, CUN, FLL, DEN), RT, outside 48 hrs.
...
//- Step 8: Fill out passenger info and click "Continue"
        ...
        //Typing email testers email for next validation
...
//- Step 15: On the confirmation page verify that a PNR and the vacation codes are created for the booking
...
//- Step 16: Validate price shown on email is a packaging price (flight+hotel+car as one price)
//- Step 17: Open the Emailtesters and locate the email used as contact for the booking.
//- Step 18: Validate that the new packaging vendors, called HotelsBeds and Carnet, information is on the Email
