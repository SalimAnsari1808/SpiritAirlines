...
//**********************************************************************************************
//Test Case ID: TC373768
//Description : US 20854 - 001 - CP - Payment Error Hotel Verbiage - Hotel Upsell - Standard Booking
//Created By  : Kartik
...
public class TC373768 extends BaseClass {
    @Parameters({"platform"})
    ...
    public void CP_Payment_Error_Hotel_Verbiage_Hotel_Upsell_Standard_Booking(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC373181 under GoldFinger Suite on " + platform + " Browser", true);
        }
...
//- Step 11: On the options page book a hotel.
        pageMethodManager.getHotelPageMethods().selectHotelOnOptionPage("MGM", "NA");

//Step 12: Validate that the Flight Flex is offered after the Hotel been selected.
        ValidationUtil.validateTestStep("Verify Flight Flex is offered on Options Page",
