...
//**********************************************************************************************
//Test Case ID: TC374009
//Description: Task 27801: TC374009- 005 - CP - Price Display Options Total - Vacation Path - Flight + Car
//Created By: Gabriela
//Created On: 3-Dec-2019
//Reviewed By:
//Reviewed On:
//**********************************************************************************************
public class TC374009 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath", "RoundTrip", "DomesticDomestic", "FlightCar", "Outside21Days", "Adult", "Guest", "NonStop", "BookIt",
            "DynamicShoppingCartUI", "CarryOn","CheckedBags", "Standard", "OptionalUI"})
    public void CP_Price_Display_Options_Total_Vacation_Path_Flight_Car(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC374009 under GoldFinger Suite on " + platform + " Browser", true);
        }
        ...
        final String DEP_BAGS           = "Carry_1|Checked_1||Carry_1|Checked_1";
        final String RET_BAGS           = "Carry_1|Checked_1||Carry_1|Checked_1";
...
//- Step 2: Create a vacation booking Flight + Car | DOM-DOM | 2 ADT | 25+ | Date 3 months in the future
...
//- Step 12: Add 1 Carry-On bag and 1 Checked bag for both passengers for both departing and returning, and click CONTINUE in the STANDARD BOX
...
//- Step 13: Click Regular seats for both passengers and click CONTINUE
...
//- Step 14: On the Options page, locate the Dynamic Shopping Cart on the right and expand all available carets
        WaitUtil.untilPageLoadComplete(getDriver());
        pageObjectManager.getHeader().getArrowYourItineraryImage().click();
        WaitUtil.untilTimeCompleted(1000);
        pageObjectManager.getHeader().getFlightItineraryPanel().click();

//- Step 15: Verify Flight + Car, Bags, Seats and Options are displaying and accurate within the Dynamic Shopping Cart
        pageObjectManager.getHeader().getFlightItineraryPanel().click();
