...
public class TC374012 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath", "RoundTrip", "DomesticDomestic", "FlightHotelCar", "Outside21Days", "Adult", "Guest", "BookIt", "CarryOn", "CheckedBags", "Standard", "OptionalUI", "DynamicShoppingCartUI"})
