...
//Test Case ID: TC373278
//Description: Task 27223: TC373278 - 007 - CP - Room Rate - Flight + Hotel - Validate Room Rates for a booking with multiple passengers and rooms
//Created By: Gabriela
...
public class TC373278 extends BaseClass {
    @Parameters({"platform"})
    ...
    public void CP_Room_Rate_Flight_Hotel_Validate_Room_Rates_for_a_booking_with_multiple_passengers_and_rooms(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC373278 under GoldFinger Suite on " + platform + " Browser", true);
        }
...
//- Step 2: Create Vacation booking F+H 3 ADT DOM-DOM
