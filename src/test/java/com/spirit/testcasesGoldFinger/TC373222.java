...
//**********************************************************************************************
//Test CaseID: TC373222
//Title      : 002 - CP - Car Verbiage - Thrifty - Flight + Car - Validate correct verbiage displays
...
public class TC373222 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath", "RoundTrip","FlightCar", "DomesticDomestic", "Outside21Days", "Adult", "Guest","CarUI"})
    public void CP_Car_Verbiage_Thrifty_Flight_Car_Validate_correct_verbiage_displays(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC373222 under GoldFinger Suite on " + platform + " Browser", true);
        }
        ...
        ValidationUtil.validateTestStep("Validating finfth Section of Vehicle Description appear under More Info link on Car Page",
