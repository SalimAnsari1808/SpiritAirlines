...
//**********************************************************************************************
//Test Case ID: TC373289
//Description : CP - Payment Declined - Car Upsell on Booking Path - Visa
//Created By  : Sunny Sok
//Created On  : 11-Nov-2019
//Reviewed By : Gabriela
//Reviewed On : 5-Dec-2019
//**********************************************************************************************
public class TC373289 extends BaseClass{
    @Parameters({"platform"})
    @Test (groups = {"OutOfExecution","BookPath" , "RoundTrip" , "DomesticDomestic" , "Outside21Days" , "Adult" , "NonStop" , "BookIt" ,
            "NoBags" , "NoSeats" , "CheckInOptions" , "Visa" , "PaymentUI" , "Cars", "ActiveBug"})
    public void CP_Payment_Declined_Car_Upsell_on_Booking_Path_Visa(@Optional("NA") String platform) {
        ...
        final String DEP_CODE       = "FLL";
        final String ARR_AIRPORTS   = "AllLocation";
        final String ARR_CODE       = "MCO";
        ...
        final String DECLINED_VISA  = "DeclinedVisa";
        ...
        pageMethodManager.getHomePageMethods().selectAirports(DEP_AIRPORTS, DEP_CODE, ARR_AIRPORTS, ARR_CODE);
