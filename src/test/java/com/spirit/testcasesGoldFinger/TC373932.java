...
//**********************************************************************************************
//Test Case ID: TC373932
//Description : TC373932 - 006 - CP - Verbiage Car Driver Below 21 - Flight + Hotel + Car - Dollar
//Created By  : Alex Rodriguez
//Created On  : 25-Nov-2019
//Reviewed By : Gabriela
//Reviewed On : 5-Dec-2019
//**********************************************************************************************
public class TC373932 extends BaseClass {
  @Parameters({"platform"})
  @Test(groups = {"BookPath", "RoundTrip", "FlightHotelCar", "Guest", "DomesticDomestic", "Outside21Days", "Adult",
          "BookIt", "MandatoryFields", "PassengerInformationUI"})
  public void CP_Verbiage_Car_Driver_Below_21_Flight_Hotel_Car_Dollar(@Optional("NA") String platform) {

    //Mention Suite and Browser in reports
    if (!platform.equals("NA")) {
      ValidationUtil.validateTestStep("Starting Test Case ID TC373932 under GoldFinger Suite on " + platform + " Browser", true);
    }
...
//  Step 3	Select "VIEW" in the Hotel content box of a Hotel you want
//  Step 4	Select "ROOMS FROM $$$" and "SELECT ROOM"
    pageMethodManager.getHotelPageMethods().selectHotelRoomHotelPage("NA", "NA");
//  Step 5	Scroll down and select "CONTINUE"
//  Step 6  Select "BOOK CAR" in the box for a Dollar car
//  Step 7  Scroll down to the bottom of the page and click CONTINUE
...
//  Step 12	Click the FLIGHT ONLY button within the Insufficient Age popup modal
    ...
    WaitUtil.untilPageURLVisible(getDriver(), "spirit.com");
