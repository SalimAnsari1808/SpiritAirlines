...
//**********************************************************************************************
public class TC373868 extends BaseClass {

  @Parameters({"platform"})
  @Test(groups = {"BookPath", "RoundTrip", "DomesticDomestic", "Outside21Days", "Adult", "Guest","Connecting", "BookIt",
                "OptionalUI", "DynamicShoppingCartUI", "CarsUI", "HotelsUI","Hotels","Cars", "NoBags","NoSeats","CheckInOptions"})
  public void CP_Price_Display_Options_Total_Hub_Packaging_Flight_with_Hotel_Car_upsell(@Optional("NA") String platform){
    if (!platform.equals("NA")) {
      ValidationUtil.validateTestStep("Starting Test Case ID TC373868 under GoldFinger Suite on " + platform + " Browser", true);
    }
    ...
    ValidationUtil.validateTestStep("\"Hotels for Less\" is displayed on the options page",
            pageObjectManager.getHotelPage().getHotelCarouselTitleText().getText(),"Hotels for Less");
