...
//Test CaseID: TC373350
//Title      : 002 - CP - Car Verbiage - Thrifty - Booking Upsell - Validate verbiage for a booking with an International Destination
...
public class TC373350 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"ActiveBug", "BookPath","RoundTrip","FlightCar","Guest","InternationalDomestic","Outside21Days","Adult","FlightAvailabilityUI",
                    "CarsUI","OptionalUI"})
    public void CP_SP_Car_Verbiage_Thrifty_Booking_Upsell_Validate_verbiage_for_a_booking_with_an_International_Destination(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC373350 under GoldFinger Suite on " + platform + " Browser", true);
        }
