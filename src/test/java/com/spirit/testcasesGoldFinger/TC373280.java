...
//Test Case ID: TC373280
//Description: Task 27225: TC373280 - 012 - CP - Room Rate - Flight + Car + Hotel - Validate Room Rates for a booking with multiple passengers and rooms
//Created By: Gabriela
...
public class TC373280 extends BaseClass {
    @Parameters({"platform"})
    ...
    public void CP_Room_Rate_Flight_Car_Hotel_Validate_Room_Rates_for_a_booking_with_multiple_passengers_and_rooms(@Optional("NA") String platform) {
...
//- Step 2: Create Vacation booking F+H+ C 2 ADT DOM-DOM - 2 rooms - drivers age 25+
