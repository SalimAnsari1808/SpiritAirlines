...
public class TC374019 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"ActiveBug" , "BookPath", "RoundTrip", "DomesticDomestic", "Outside21Days", "Adult", "Guest", "NonStop", "BookIt", "NoBags", "NoSeats", "OptionalUI","Cars","Hotels" ,"CheckInOptions","Discover","ConfirmationUI", "DynamicShoppingCartUI"})
