...
//**********************************************************************************************
//Test Case ID: TC373422
//Description: Task 27871: TC373422 - 015 - CP - Car Tax Verbiage (with Hotel) - Flight + Hotel - Validate the verbiage for a booking on a Connecting Flight
// Created By: Gabriela
//Created On: 30-Nov-2019
//Reviewed By: Anthony Cardona
//Reviewed On: 06-Dec-2019
//**********************************************************************************************
public class TC373422 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath", "RoundTrip", "DomesticDomestic", "FlightHotel", "Outside21Days", "Adult", "Guest", "Connecting", "FlightAvailabilityUI", "CarsUI", "HotelsUI"})
    public void Car_Tax_Verbiage_with_Hotel_Flight_Hotel_Validate_the_verbiage_for_a_booking_on_a_Connecting_Flight(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC373422 under GoldFinger Suite on " + platform + " Browser", true);
        }
...
//- Step 11: On the Car availability page scroll down to a Dollar car content box
//- Step 12: On the Car availability page scroll down to a Dollar car content box
        pageMethodManager.getCarPageMethods().filterCarByRentalAgency("Dollar");

//- Step 13: Click "More" in the tile of one of the Dollar cars
...
//- Step 14: Click the "Less" in the expanded tile. Validate that the tile collapses and the user remains on the Car availability page.
