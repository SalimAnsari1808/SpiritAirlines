...
public class TC373209 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath", "RoundTrip","FlightHotelCar", "DomesticDomestic", "Outside21Days", "Adult", "Guest","CarUI"})
    public void Car_Verbiage_Alamo_Flight_Car_Validate_correct_verbiage_displays_5_ADT(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC373209 under GoldFinger Suite on " + platform + " Browser", true);
        }
