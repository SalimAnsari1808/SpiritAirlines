...
//**********************************************************************************************
//Test Case ID: TC373433
//Description: Task 27821: TC373433- 014 - CP - Room Rate - Flight + Car + Hotel - Validate Room Rates for a booking with an International Destination
// Created By: Gabriela
...
public class TC373433 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath", "RoundTrip", "DomesticDomestic", "FlightHotelCar", "Outside21Days", "Adult", "Guest", "FlightAvailabilityUI", "HotelsUI"})
    public void CP_Room_Rate_Flight_Car_Hotel_Validate_Room_Rates_for_a_booking_with_an_International_Destination(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC373433 under GoldFinger Suite on " + platform + " Browser", true);
        }
...
//- Step 2: Create Vacation booking F+H+ C 1 ADT DOM-INT - 1 room - drivers age 25+
...
//- Step 4: under " Choose your hotel"  you should see a list of hotels
        int countHotel  = 0;
...
//- Step 7: access HBG webiste
        //TODO: HBG Verification method need it
