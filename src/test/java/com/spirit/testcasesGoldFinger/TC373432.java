...
//**********************************************************************************************
//Test Case ID: TC373432
//Description: Task 27875: TC373432 - 010 - CP - Room Rate - Flight + Hotel - Validate Room Rates for a booking with an International Origin
// Created By: Gabriela
//Created On: 30-Nov-2019
//Reviewed By: Anthony Cardona
//Reviewed On: 06-Dec-2019
//**********************************************************************************************
public class TC373432 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath", "RoundTrip", "FlightHotel", "InternationalDomestic", "Outside21Days", "Adult", "Guest", "NonStop", "HotelsUI", "FlightAvailabilityUI"})
    public void CP_Room_Rate_Flight_Hotel_Validate_Room_Rates_for_a_booking_with_an_International_Origin(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC373432 under GoldFinger Suite on " + platform + " Browser", true);
        }
...
//- Step 2: Create Vacation booking F+H 1 ADT INT-DOM
