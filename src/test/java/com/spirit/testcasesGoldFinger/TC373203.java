...
//**********************************************************************************************
//Test CaseID: TC373203
//Title      : 002 - CP - Car Verbiage - Enterprise - Flight + Car - Validate correct verbiage displays
...
public class TC373203 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"BookPath", "RoundTrip", "FlightHotelCar", "DomesticDomestic","Outside21Days","Guest","CarsUI"})
    public void CP_Car_Verbiage_Enterprise_Flight_Car_Validate_correct_verbiage_displays(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC373203 under GoldFinger Suite on " + platform + " Browser", true);
        }
