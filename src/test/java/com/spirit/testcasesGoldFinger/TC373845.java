...
//Test Case ID: TC373845
//Description: Task 27244: TC373845 - US 22065 - 003 - CP - BP - Check-In and Check-Out Format - Flight + Hotel - Validate the Facade of the hotel Check-In and Check-Out time
// Created By: Gabriela
//Created On: 1-Dec-2019
//Reviewed By: Anthony Cardona
//Reviewed On: 04-Dec-2019
//**********************************************************************************************
public class TC373845 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"ActiveBug", "BookPath", "RoundTrip", "FlightHotel", "DomesticDomestic", "Outside21Days", "Adult", "Guest", "BookIt", "NoBags", "NoSeats",
    ...
    public void CP_BP_Check_In_and_Check_Out_Format_Flight_Hotel_Validate_the_Facade_of_the_hotel_Check_In_and_Check_Out_time(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC373845 under GoldFinger Suite on " + platform + " Browser", true);
        }
...
//- Step 12: Complete the payment of the booking.
    ...
    //- Step 14: Record the PNR and last name.
            //TODO: [IN:25569]: CP: BP: Confirmation Page: Banner says "Total Due" instead of "Total Paid"
