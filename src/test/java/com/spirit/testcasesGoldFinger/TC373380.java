...
//Test CaseID: TC373380
//Title      : 002 - CP - Car Verbiage - Dollar - Flight + Car - Validate verbiage  for a booking with an International Destination
//Created By : Kartik Chauhan
//Created On : 26-Nov-2019K
//Reviewed By: Gabriela
//Reviewed On: 9-Dec-2019
//**********************************************************************************************

public class TC373380 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"ActiveBug", "BookPath","RoundTrip","FlightCar","Guest","DomesticInternational","Outside21Days","Adult","CarsUI"})
    public void CP_Car_Verbiage_Dollar_Flight_Car_Validate_verbiage_for_a_booking_with_an_International_Destination(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC373380 under GoldFinger Suite on " + platform + " Browser", true);
        }
        ...
        final String VEHICLE_DESCRIPTION2    = "A valid major credit card in the renter’s name must be presented with available credit in the deposit amount (if applicable).";
        ...
        pageMethodManager.getCarPageMethods().filterCarByRentalAgency("HERTZ"); //Switching to Hertz, due we are not receiving Dollar con Cancun
