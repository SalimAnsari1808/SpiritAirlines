...
public class TC373999 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath", "RoundTrip", "DomesticDomestic", "FlightHotel", "Outside21Days", "Adult", "Guest", "BookIt", "NoBags", "NoSeats", "OptionalUI","CheckInOptions","DynamicShoppingCartUI","Visa"})
    public void CP_Price_Display_Shopping_Cart_Vacation_Path_Flight_Hotel_with_Edit_made_to_Hotel(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC373999 under GoldFinger Suite on " + platform + " Browser", true);
        }
