...
public class PRODTC374010 extends BaseClass {
    @Parameters({"platform"})
    ...
    public void CP_Price_Display_Options_Total_Vacation_Path_Flight_Hotel_with_Edit_made_to_Hotel(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC374010 under GoldFinger Suite on " + platform + " Browser", true);
        }
