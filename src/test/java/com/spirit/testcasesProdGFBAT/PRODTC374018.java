...
public class PRODTC374018 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"Production"})
    public void CP_Price_Display_Total_Due_Hub_Packaging_Flight_with_Hotel_upsell(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC374018 under GoldFinger Suite on " + platform + " Browser", true);
        }
