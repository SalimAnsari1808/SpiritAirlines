...
//Reviewed On:
//**********************************************************************************************
public class PRODTC374011 extends BaseClass {
    @Parameters({"platform"})
    ...
    public void  CP_Price_Display_Options_Total_Vacation_Path_Flight_Car_with_Edit_made_to_Car(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC374011 under GoldFinger Suite on " + platform + " Browser", true);
        }
