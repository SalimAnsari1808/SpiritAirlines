...
//**********************************************************************************************
//TODO: [IN:25405] Goldfinger: Intermittent: CP: BP: Option page: after spending some time in the page the user is unable to select a Car or Hotel.
...
public class PRODTC374008 extends BaseClass {
    @Parameters({"platform"})
...
//        WaitUtil.untilPageLoadComplete(getDriver());
        ...
        if(!pageObjectManager.getHeader().getArrowYourItineraryImage().findElement(By.xpath("//i")).getAttribute("style").contains("(0deg)")){
            System.out.println("insode the if statement");
