...
public class PRODTC373996 extends BaseClass {
    @Parameters({"platform"})
    ...
    public void CP_Price_Display_Shopping_Cart_Hub_Packaging_Remove_Hotel_from_reservation_on_Hotel_upsell(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC373996 under GoldFinger Suite on " + platform + " Browser", true);
        }
