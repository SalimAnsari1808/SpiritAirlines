...
//**********************************************************************************************
// Test Case ID: TC91353
// Description: Taxes and Fees_CP_BP_RT_To Jamaica (Monetgo Bay)
// Created By : Kartik Chauhan
// Created On : 05-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 10-Apr-2019
//**********************************************************************************************
public class TC91353 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_To_Jamaica_Monetgo_Bay (@Optional("NA")String platform){

        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91353 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        final String ARR_AIRPORT_CODE 	= "MBJ";
