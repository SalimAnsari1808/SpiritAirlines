...
//**********************************************************************************************
//Test Case ID: TC371642
//Description: E2E_Guest_OW DOM 0 ADT 1 UMNR_Thru Flight_Bundle It [Tier 3]_Standard_1co 1cb_Any Seats_No Extras CI Web_Credit Card
//Created By : Sunny Sok
//Created On : 18-Mar-2019
//Reviewed By: Salim Ansari
//Reviewed On: 23-April-2019
//**********************************************************************************************
public class TC371642 extends BaseClass {

    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "OneWay" ,"NonStop", "DomesticDomestic" , "WithIn7Days" , "Child" ,
            "Guest" , "BundleIt" , "DynamicShoppingCartUI", "CarryOn" , "CheckedBags" , "Standard" ,
            "FlightFlex" , "ShortCutBoarding" , "CheckInOptions" , "MasterCard","BagsUI","OptionalUI",
            "PaymentUI","ConfirmationUI"})
    public void E2E_Guest_OW_DOM_0_ADT_1_UMNR_Thru_Flight_Bundle_It_Tier3_Standard_1co_1cb_Any_Seats_No_Extras_CI_Web_Credit_Card(@Optional("NA") String platform) {
        /******************************************************************************
         ***************************Navigate to Confirmation Page**********************
         ******************************************************************************/
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC371642 under SMOKE Suite on " + platform + " Browser"   , true);
        }
