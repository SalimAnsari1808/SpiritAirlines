...
//**********************************************************************************************
// Test Case ID: TC91327
// Description: Taxes and Fees_CP_BP_RT_From Dominican Republic (Santo Domingo)
// Created By : Kartik Chauhan
// Created On : 17-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 17-Apr-2019
//**********************************************************************************************
public class TC91327 extends BaseClass {
    ...
    @Test (groups = {"BookPath" , "RoundTrip" , "InternationalDomestic" , "Outside21Days" , "Adult" , "Guest" ,"Connecting" , "BookIt" ,
            "CarryOn" , "CheckedBags" , "NoSeats" , "CheckInOptions" , "MasterCard", "TaxesAndFee","TravelInsuranceBlock", "PaymentUI" ,"ConfirmationUI", "BagsUI"})
    public void Taxes_and_Fees_CP_BP_RT_From_Dominican_Republic_Santo_Domingo (@Optional("NA")String platform){
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91327 under SMOKE Suite on " + platform + " Browser"   , true);
        }
