...
//**********************************************************************************************
//Test Case ID: TC281061
//Description: E2E_Guest_OW DOM 0 ADT 1 UMNR_Thru Flight_Bundle It [Tier 3]_Standard_1co 1cb_Any Seats_No Extras CI Web_Mastercard
//Created By : Sunny Sok
//Created On : 17-May-2019
//Reviewed By: Salim Ansari
//Reviewed On: 20-May-2019
//**********************************************************************************************
public class TC281061 extends BaseClass {

    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "WithIn7Days" , "Child" , "Guest" , "Through" ,
                     "BundleIt" , "DynamicShoppingCartUI" , "CarryOn" , "CheckedBags" , "BagsUI" , "Standard" , "SeatsUI" ,
                     "FlightFlex" , "ShortCutBoarding" , "OptionalUI" , "PaymentUI" , "MasterCard"})
    public void E2E_Guest_OW_DOM_0_ADT_1_UMNR_Thru_Flight_Bundle_It_Tier_3_Standard_1co_1cb_Any_Seats_No_Extras_CI_Web_Mastercard(@Optional("NA") String platform) {
        /******************************************************************************
         ***************************Navigate to Confirmation Page**********************
         ******************************************************************************/
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC281061 under SMOKE Suite on " + platform + " Browser"   , true);
        }
