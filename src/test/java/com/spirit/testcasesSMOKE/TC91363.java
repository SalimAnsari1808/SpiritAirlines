...
// **********************************************************************************************
//Test Case ID: TC91363
// Description: Taxes and Fees_CP_BP_RT_To Panama
// Created By : Kartik Chauhan
// Created On : 17-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 17-Apr-2019
// **********************************************************************************************
public class TC91363 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_To_Panama (@Optional("NA")String platform){

        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91363 under SMOKE Suite on " + platform + " Browser"   , true);
        }
