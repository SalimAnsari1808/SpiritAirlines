...
//**********************************************************************************************
//Test Case ID: TC355315
//Description: E2E_Guest_OW Dom 0 ADT 1 UMNR_Thru Flight_No Bags_No Seats_No Extras CI_AMX
//Created By : Alex Rodriguez
//Created On : 21-May-2019
//Reviewed By: Salim Ansari
//Reviewed On: 22-May-2019
//**********************************************************************************************
public class TC355315 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "WithIn7Days" , "Child" , "Guest" ,
                    "Through" , "BundleIt" , "DynamicShoppingCartUI" , "CarryOn" , "CheckedBags" , "Standard" , "SeatsUI" ,
                    "FlightFlex" , "ShortCutBoarding" , "CheckInOptions" , "AmericanExpress" , "OptionalUI" , "PaymentUI"})
    public void E2E_Guest_OW_Dom_0_ADT_1_UMNR_Thru_Flight_No_Bags_No_Seats_No_Extras_CI_AMEX(@Optional("NA") String platform) {
        /******************************************************************************
         ***************************Navigate to Confirmation Page**********************
         ******************************************************************************/
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC355315 under SMOKE Suite on " + platform + " Browser"   , true);
        }
