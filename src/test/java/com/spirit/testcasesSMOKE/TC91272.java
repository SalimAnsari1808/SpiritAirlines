...
//**********************************************************************************************
//Test Case ID: TC91272
//Description: Validate the Redeem Miles page on "My Account" validate links and current Mileage
//Created By : Anthony Cardona
//Created On : 27-Mar-2019
//Reviewed By: Salim Ansari
//Reviewed On: 2-Apr-2019
//**********************************************************************************************
public class TC91272 extends BaseClass {

    @Parameters({"platform"})
    @Test (groups = {"Header" , "FreeSpirit" ,"BookPath", "AccountProfileUI"})
    public void My_Account_CP_FS_Redeem_Miles_Link(@Optional("NA") String platform) {
        //mention the browser
        if(!platform.equals("NA")){
            ValidationUtil.validateTestStep("Starting Test Case ID TC91272 under SMOKE suite on " + platform +" Browser", true);
        }
...
//Step - 9
        ...
        ValidationUtil.validateTestStep("The Current mileage text1 is correct on Redeem Miles Page" , currentMiles,CURRENT_MILEAGE_TEXT1);
        ValidationUtil.validateTestStep("The Current mileage text2 is correct on Redeem Miles Page" , currentMiles,CURRENT_MILEAGE_TEXT2);
        ValidationUtil.validateTestStep("The Current mileage text3 is correct on Redeem Miles Page" , currentMiles,CURRENT_MILEAGE_TEXT3);
