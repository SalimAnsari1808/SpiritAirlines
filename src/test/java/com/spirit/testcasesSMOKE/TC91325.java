...
// **********************************************************************************************
//Test Case ID: TC91325
// Description: Taxes and Fees_CP_BP_RT_To Costa Rica
// Created By : Kartik Chauhan
// Created On : 01-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 04-Apr-2019
// **********************************************************************************************
public class TC91325 extends BaseClass {
    //**********************Navigation to Purchase Page******************************/
    @Parameters ({"platform"})
    @Test(groups = {"BookPath" , "RoundTrip" , "DomesticInternational" , "Outside21Days" , "Adult" , "Guest" , "Connecting" , "BookIt" ,
            "NoBags" , "NoSeats" , "CheckInOptions" , "TravelInsuranceBlock" , "MasterCard" , "TaxesAndFee" , "PaymentUI", "ConfirmationUI"})
    public void Taxes_and_Fees_CP_BP_RT_To_Costa_Rica (@Optional("NA")String platform){
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91325 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        final String ARR_AIRPORT_CODE 	= "SJO";
        final String DEP_DATE 			= "27";
...
//STEP--2
        ...
        taxList.add("CR - National Tourism Fee");
...
//            ValidationUtil.validateTestStep("Verifing Tax verbiages To COSTA RICA City pair of Tax " + (taxList.get(taxCounter)) + " on Payment Page", taxFlag);
//
...
//        ValidationUtil.validateTestStep("All Taxes To COSTA RICA is displaying correctly for Roundtrip on Payment Page", true);
...
//
//            //validate for all the taxes in console
//            ValidationUtil.validateTestStep("Verifing Tax verbiages To COSTA RICA City pair of Tax " + (taxList.get(taxCounter)) + " on Confirmation Page", taxFlag);
//
//            //set flag to false for next tax
//            taxFlag = false;
//
...
//
//        //Validate All Taxes are displaying correctly
//        ValidationUtil.validateTestStep("All Taxes To COSTA RICA is displaying correctly for Roundtrip on Confirmation Page", true);
