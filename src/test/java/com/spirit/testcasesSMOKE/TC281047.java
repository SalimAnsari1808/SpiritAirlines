...
public class TC281047 extends BaseClass {
    ...
    @Test(groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "Child" , "Guest" , "NonStop"
                    ...
                    , "AmericanExpressCard","PaymentUI","ConfirmationUI"})
    public void  E2E_Guest_OW_Dom_1_ADT_1_Child_5_15_Direct_Flight_No_Bags_No_Seats_SS_SB_FF_CI_Airport_Amex (@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC281047 under SMOKE Suite on " + platform + " Browser", true);
        }
