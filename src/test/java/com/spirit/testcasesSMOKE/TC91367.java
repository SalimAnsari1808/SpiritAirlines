...
//**********************************************************************************************
// Test Case ID: TC91367
// Description: Taxes and Fees_CP_BP_RT_To Saint Maarten
// Created By : Kartik Chauhan
// Created On : 09-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 11-Apr-2019
//**********************************************************************************************
public class TC91367 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_To_Saint_Maarten (@Optional("NA")String platform){

        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91367 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        final String ARR_AIRPORT_CODE 	= "SXM";
