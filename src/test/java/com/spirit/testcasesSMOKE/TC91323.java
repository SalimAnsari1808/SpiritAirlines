...
//**********************************************************************************************
// Test Case ID: TC91323
// Description: Taxes and Fees_CP_BP_RT_From Aruba
// Created By : Kartik Chauhan
// Created On : 16-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 16-Apr-2019
//**********************************************************************************************
public class TC91323 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_From_Aruba (@Optional("NA")String platform){
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91323 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        final String DEP_AIRPORT_CODE 	= "AUA";
...
//STEP--2
        ...
        taxList.add("AW-PAX Facility and Security");
        taxList.add("AW-Special Facility Charge");
