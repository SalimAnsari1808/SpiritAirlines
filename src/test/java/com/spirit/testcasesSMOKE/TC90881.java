...
//**********************************************************************************************
//Test CaseID: TC90881
//Title      : Check In_CP_CI_Passport_Validate Passport required fields value acceptance OW INT
//Created By : Kartik Chauhan
//Created On : 30-Apr-2019
//Reviewed By: Salim Ansari
//Reviewed On: 1-May-2019
//**********************************************************************************************
public class TC90881 extends BaseClass{
    @Parameters ({"platform"})
    @Test (groups = {"CheckIn" , "OneWay" , "DomesticColombia" , "WithIn7Days" , "Adult" , "Guest" , "Connecting" , "BookIt" ,
            "NoBags" , "NoSeats" , "CheckInOptions" , "PassportUI" , "TravelInsurancePopUp" , "MasterCard" , "AddEditPassportInfo"})
    public void Check_In_CP_CI_Passport_Validate_Passport_required_fields_value_acceptance_OW_INT(@Optional("NA")String platform) {
        //**************Navigate to Bags Page*****************************
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC90881 under SMOKE Suite on " + platform + " Browser"   , true);
        }
