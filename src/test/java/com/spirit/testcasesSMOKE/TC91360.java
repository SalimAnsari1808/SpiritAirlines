...
//**********************************************************************************************
// Test Case ID: TC91360
// Description: Taxes and Fees_CP_BP_RT_From Nicaragua
// Created By : Kartik Chauhan
// Created On : 17-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 17-Apr-2019
//**********************************************************************************************
public class TC91360 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_From_Nicaragua (@Optional("NA")String platform){
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91360 under SMOKE Suite on " + platform + " Browser"   , true);
        }
...
//STEP--3
        ...
        taxList.add("NI Terminal Fee");
        taxList.add("NI Security Fee");
        taxList.add("US-International Departure/Arrival Tax");
        taxList.add("NI-Tourism Fee");
