...
// **********************************************************************************************
public class TC90950 extends BaseClass {

    @Parameters ({"platform"})
    @Test(groups = {"BookPath" , "RoundTrip" , "DomesticColombia" , "Outside21Days" ,"Guest", "Adult" , "NonStop" , "BookIt" , "NewFlightSearch"})
    public void Flight_Availability_CP_BP_Advanced_Search_Widget_Functionality_Validate_the_OW_INT_travel_message_pops_up_for_DOM_INT (@Optional("NA")String platform){
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC90950 under SMOKE Suite on " + platform + " Browser"   , true);
        }
