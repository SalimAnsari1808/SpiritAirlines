...
//**********************************************************************************************
public class TC378518 extends BaseClass {
    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "RoundTrip" ,"Nonstop" ,"NineDFC" , "DomesticDomestic" , "WithIn7Days",
            "Adult","Child" , "BookIt" , "OptionalUI" , "FlightFlex" , "ShortCutBoarding" , "ShortCutSecurity" ,
            "CheckInOptions" , "AmericanExpress","NoBags","NoSeats" ,"PaymentUI","ConfirmationUI"})
    public void  E2E_9DFC_RT_DOM_1_ADT_1_Child_5_15_DirectFlight_Standard_NoBags_NoSeats_SS_SB_FF_CI_Airport_Amex(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC378518 under SMOKE Suite on " + platform + " Browser", true);
        }
