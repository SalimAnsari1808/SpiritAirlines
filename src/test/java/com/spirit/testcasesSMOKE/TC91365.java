...
//**********************************************************************************************
// Test Case ID: TC91365
// Description: Taxes and Fees_CP_BP_RT_To Peru
// Created By : Kartik Chauhan
// Created On : 09-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 11-Apr-2019
//**********************************************************************************************
public class TC91365 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_To_Peru (@Optional("NA")String platform){

        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91365 under SMOKE Suite on " + platform + " Browser"   , true);
        }
