...
//**********************************************************************************************
// Test Case ID: TC91355
// Description: Taxes and Fees_CP_BP_RT_To Jamaica (Kingston)
// Created By : Kartik Chauhan
// Created On : 04-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 04-Apr-2019
//**********************************************************************************************
public class TC91355 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_To_Jamaica_Kingston (@Optional("NA")String platform){
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91355 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        final String ARR_AIRPORT_CODE 	= "KIN";
        final String DEP_DATE 			= "29";
...
//STEP--4
        ...
        taxList.add("JM Tourist Enhancement Fee");
        taxList.add("JM Airline Passenger Levy");
        ...
        for (int taxCounter = 0; taxCounter < taxList.size(); taxCounter++) {
            ...
            ValidationUtil.validateTestStep("Verifing Tax verbiages To Jamaica (Kingston) City pair of Tax " + (taxList.get(taxCounter)) + " on Payment Page", taxFlag);
        ...
        ValidationUtil.validateTestStep("All Taxes To Jamaica (Kingston) is displaying correctly for Roundtrip on Payment Page", true);
...
//STEP--6
        ...
        for (int taxCounter = 0; taxCounter < taxList.size(); taxCounter++) {
            ...
            //validate for all the taxes in console
            ValidationUtil.validateTestStep("Verifing Tax verbiages To Jamaica (Kingston) City pair of Tax " + (taxList.get(taxCounter)) + " on Confirmation Page", taxFlag);
        ...
        //Validate All Taxes are displaying correctly
        ValidationUtil.validateTestStep("All Taxes To Jamaica (Kingston) is displaying correctly for Roundtrip on Confirmation Page", true);
