...
// **********************************************************************************************
//Test Case ID: TC91345
// Description: Taxes and Fees_CP_BP_RT_To Guatemala
// Created By : Kartik Chauhan
// Created On : 02-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 04-Apr-2019
// **********************************************************************************************
public class TC91345 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_To_Guatemala (@Optional("NA")String platform){
        //***********************Navigation on Purchase Page***************************/
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91345 under SMOKE Suite on " + platform + " Browser"   , true);
        }
