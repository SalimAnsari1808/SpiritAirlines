...
//**********************************************************************************************
//Test Case ID: TC281067
//Description: E2E_Guest_OW DOM 1 ADT 1 Child 2-5_Connecting Flight_Bundle It [Tier 3] _Standard_1co 1 cb_Any Seats_No Extras CI Web_Credit Card
//Created By : Sunny Sok
//Created On : 21-May -2019
//Reviewed By: Salim Ansari
//Reviewed On: 22-May -2019
//**********************************************************************************************
public class TC281067 extends BaseClass {

    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "Child" , "Guest" , "Connecting" ,
                     "BundleIt" , "CarryOn" , "CheckedBags" , "BagsUI" , "Standard" , "SeatsUI" , "FlightFlex" , "ShortCutBoarding" ,
                     "CheckInOptions" , "OptionalUI" , "Visa" , "PaymentUI","DynamicShoppingCartUI"})
    public void E2E_Guest_OW_DOM_1_ADT_1_Child_2_to_5_Connecting_Flight_Bundle_It_Tier_3_Standard_1co_1_cb_Any_Seats_No_Extras_CI_Web_Credit_Card(@Optional("NA") String platform) {
        /******************************************************************************
         ***************************Navigate to Confirmation Page**********************
         ******************************************************************************/
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC281067 under SMOKE Suite on " + platform + " Browser"   , true);
        }
