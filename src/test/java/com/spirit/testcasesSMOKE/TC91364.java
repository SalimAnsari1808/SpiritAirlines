...
//**********************************************************************************************
// Test Case ID: TC91364
// Description: Taxes and Fees_CP_BP_RT_From Peru (Lima)
// Created By : Kartik Chauhan
// Created On : 15-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 15-Apr-2019
//**********************************************************************************************
public class TC91364 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_From_Peru_Lima (@Optional("NA")String platform){
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91364 under SMOKE Suite on " + platform + " Browser"   , true);
        }
