...
public class TC90718 extends BaseClass{
    @Parameters ({"platform"})
    @Test (groups = {"BookPath" , "RoundTrip" , "DomesticDomestic" , "Outside21Days" , "Adult" , "Guest" , "Connecting" , "BookIt" , "CarryOn" , "CheckedBags", "BagsUI" })
    public void KEEP_BAG_SAME_FOR_ALL_FLIGHTS_RT_or_MC (@Optional("NA")String platform) {
     //Steps 1-2
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC90718 under SMOKE Suite on " + platform + " Browser"   , true);
