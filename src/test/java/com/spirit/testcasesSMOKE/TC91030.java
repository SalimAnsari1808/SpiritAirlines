...
//**********************************************************************************************
//Test Case ID: TC91030
//Test Name: Customer Info_CP_BP _9DFC member forgot password FS number
//Description:
...
//**********************************************************************************************
public class TC91030 extends BaseClass{
    @Parameters({"platform"})
    ...
    public void Customer_Info_CP_BP_9DFC_member_forgot_password_FS_number(@Optional("NA") String platform) {
        //************************Navigate to Retrieve Password Page***************/
        //Mention Suite and Browser in reports
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91030 under SMOKE Suite on " + platform + " Browser", true);
        }
...
//Step 5,6: input incorrect FS email address and click send to get email
...
//Step 9 and 10: Go to the email you used to sign up to your $9FC membership
