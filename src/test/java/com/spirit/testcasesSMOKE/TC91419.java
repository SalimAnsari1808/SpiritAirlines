...
//**********************************************************************************************
//Test Case ID: TC91419
//Description:  CP_BP_Payment Page_FS_use fraudulent CC
//Created By : Sunny Sok
//Created On : 08-May-2019
//Reviewed By: Salim Ansari
//Reviewed On: 09-May-2019
//**********************************************************************************************
public class TC91419 extends BaseClass{

    @Parameters({"platform"})
    @Test (groups = {"OutOfExecution","BookPath" , "OneWay" , "DomesticDomestic" , "Outside21Days" , "Adult" , "FreeSpirit" , "NonStop" , "BookIt" ,
            "NoBags" , "NoSeats" , "CheckInOptions" , "MasterCard" , "PaymentUI"})
    public void CP_BP_Payment_Page_FS_use_fraudulent_CC(@Optional("NA") String platform) {

        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91419 under SMOKE Suite on " + platform + " Browser" , true);
        }
        ...
        ValidationUtil.validateTestStep("User verify Navigated to Payment page", getDriver().getCurrentUrl().contains(PAYMENT_URL));
