...
//**********************************************************************************************
// Test Case ID: TC91370
// Description: Taxes and Fees_CP_BP_OW_From Colombia (Bogota)
// Created By : Kartik Chauhan
// Created On : 16-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 17-Apr-2019
//**********************************************************************************************
public class TC91370 extends BaseClass {
    /******************************************************************************
     ***********************Navigation to Purchase Page****************************
     ******************************************************************************/
    @Parameters ({"platform"})
    @Test(groups = {"BookPath" , "OneWay" , "ColombiaDomestic" , "Outside21Days" , "Adult" , "NonStop" , "BookIt" , "Guest" ,
            "CarryOn" , "CheckedBags" , "NoSeats" , "TravelInsuranceBlock" , "MasterCard" , "TaxesAndFee" , "PaymentUI" , "CheckInOptions", "ConfirmationUI", "BagsUI" })
    public void Taxes_and_Fees_CP_BP_OW_From_Colombia_Bogota (@Optional("NA")String platform){
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91370 under SMOKE Suite on " + platform + " Browser"   , true);
        }
