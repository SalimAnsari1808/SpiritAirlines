...
//**********************************************************************************************
// Test Case ID: TC91339
// Description:  Taxes and Fees_CP_BP_RT_ from Colombia (Medellin)
// Created By : Kartik Chauhan
// Created On : 16-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 17-Apr-2019
//**********************************************************************************************
public class TC91339 extends BaseClass {
    /******************************************************************************
    ...
    public void Taxes_and_Fees_CP_BP_RT_From_Colombia_Medellin (@Optional("NA")String platform){
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91339 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        final String DEP_AIRPORT_CODE   = "MDE";
...
//STEP--3
        ...
        ValidationUtil.validateTestStep("VAT Tax are correctly displaying on Payment Page ",
                scenarioContext.getContext(Context.BAGS_DEP_VAT).equals(Double.parseDouble(pageObjectManager.getPaymentPage().getDepTotalDueBagsVatPriceText().getText().replace("$", "").trim())));
...
//STEP--4
        ...
        ValidationUtil.validateTestStep("Vat Tax are correctly displaying on Confirmation Page ",
                scenarioContext.getContext(Context.BAGS_DEP_VAT).equals(Double.parseDouble(pageObjectManager.getConfirmationPage().getVatTaxAmountText().getText().replace("$", "").trim())));
