...
//**********************************************************************************************
// Test Case ID: TC91341
// Description: Taxes and Fees_CP_BP_RT_To Ecuador (Guayaquil)
// Created By : Kartik Chauhan
// Created On : 18-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 18-Apr-2019
//**********************************************************************************************
public class TC91341 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_To_Ecuador_Guayaquil (@Optional("NA")String platform){

        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91341 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        final String ARR_AIRPORT_CODE   = "GYE";
...
//STEP--2 & STEP--3
        ...
        taxList.add("Infrastructure Tax");
