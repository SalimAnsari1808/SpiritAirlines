...
public class TC91051 extends BaseClass {
    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "RoundTrip" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "NonStop", "BundleIt","FlightAvailabilityUI"})
    public void Flight_Availability_CP_BP_Validate_Bundle_Upsell_Pop_up_Wireframe(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91051 under SMOKE Suite on " + platform + " Browser", true);
        }
