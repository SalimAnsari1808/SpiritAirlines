...
// **********************************************************************************************
//Test Case ID: TC91324
// Description: Taxes and Fees_CP_BP_RT_To ARUBA
// Created By : Kartik Chauhan
// Created On : 02-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 04-Apr-2019
// **********************************************************************************************
public class TC91324 extends BaseClass {
    //******************************************************************************
    ...
    public void Taxes_and_Fees_CP_BP_RT_To_ARUBA (@Optional("NA")String platform){

        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91324 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        final String ARR_AIRPORT_CODE 	= "AUA";
...
//STEP--2
        ...
        taxList.add("AWTravel Promotion Levy");
        ...
        for (int taxCounter = 0; taxCounter < taxList.size(); taxCounter++) {
            ...
            ValidationUtil.validateTestStep("Verifing Tax verbiages To ARUBA City pair of Tax " + (taxList.get(taxCounter)) + " on Payment Page", taxFlag);
        ...
        ValidationUtil.validateTestStep("All Taxes To ARUBA is displaying correctly for Roundtrip on Payment Page", true);
...
//STEP--3
        ...
        for (int taxCounter = 0; taxCounter < taxList.size(); taxCounter++) {
            ...
            //validate for all the taxes in console
            ValidationUtil.validateTestStep("Verifing Tax verbiages To ARUBA City pair of Tax " + (taxList.get(taxCounter)) + " on Confirmation Page", taxFlag);
        ...
        //Validate All Taxes are displaying correctly
        ValidationUtil.validateTestStep("All Taxes To ARUBA is displaying correctly for Roundtrip on Confirmation Page", true);
