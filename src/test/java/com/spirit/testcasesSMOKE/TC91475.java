...
//**********************************************************************************************
public class TC91475 extends BaseClass{

    @Parameters ({"platform"})
    @Test (groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "Within21Days" , "Adult" , "Military" , "NonStop" , "BundleIt" , "PassengerInformationUI"})
    public void Customer_Info_CP_BP_Military_purchasing_bundle_is_able_to_continue_with_free_bags_and_drop_the_bundle (@Optional("NA")String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91475 under Smoke Suite on " + platform + " Browser"   , true);
        }
