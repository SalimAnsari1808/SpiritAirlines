...
//**********************************************************************************************
// Test Case ID: TC91349
// Description: Taxes and Fees_CP_BP_RT_To Haiti (Port-Au-Prince)
// Created By : Kartik Chauhan
// Created On : 03-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 04-Apr-2019
//**********************************************************************************************
public class TC91349 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_To_Haiti_Port_Au_Prince (@Optional("NA")String platform){

        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91349 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        final String ARR_AIRPORT_CODE 	= "PAP";
...
//STEP--4
        ...
        for (int taxCounter = 0; taxCounter < taxList.size(); taxCounter++) {
            ...
            ValidationUtil.validateTestStep("Verifying Tax verbiages To Haiti (Port-Au-Prince) City pair of Tax " + (taxList.get(taxCounter)) + " on Payment Page", taxFlag);
        ...
        ValidationUtil.validateTestStep("All Taxes To Haiti (Port-Au-Prince) is displaying correctly for Roundtrip on Payment Page", true);
...
//STEP--6
        ...
        for (int taxCounter = 0; taxCounter < taxList.size(); taxCounter++) {
            ...
            //validate for all the taxes in console
            ValidationUtil.validateTestStep("Verifing Tax verbiages To Haiti (Port-Au-Prince) City pair of Tax " + (taxList.get(taxCounter)) + " on Confirmation Page", taxFlag);
        ...
        //Validate All Taxes are displaying correctly
        ValidationUtil.validateTestStep("All Taxes To Haiti (Port-Au-Prince) is displaying correctly for Roundtrip on Confirmation Page", true);
