...
//**********************************************************************************************
public class TC281412 extends BaseClass {
    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "OneWay" , "DomesticInternational" , "WithIn7Days" , "Adult" , "NineDFC" ,
            "NonStop" , "BoostIt" , "DynamicShoppingCartUI" , "BagsUI" , "CheckedBags" , "Standard" ,
            "ShortCutBoarding" , "CheckInOptions" , "OptionalUI" , "MasterCard","SeatsUI","PaymentUI","ConfirmationUI"})
    public void E2E_9DFC_OW_INT_Multi_ADT_Direct_Flight_STD_1CO_1CB_Any_Seats_No_Extras_CI_Web_Credit_Card(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC281412 under SMOKE Suite on " + platform + " Browser", true);
        }
