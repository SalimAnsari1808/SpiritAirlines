...
//**********************************************************************************************
// Test Case ID: TC91328
// Description: Taxes and Fees_CP_BP_RT_To Dominican Republic (Punta Cana)
// Created By : Kartik Chauhan
// Created On : 10-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 11-Apr-2019
//**********************************************************************************************
public class TC91328 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_To_Dominican_Republic_Punta_Cana (@Optional("NA")String platform){
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91328 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        final String ARR_AIRPORT_CODE 	= "PUJ";
        final String DEP_DATE 			= "64";
