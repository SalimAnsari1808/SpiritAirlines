...
//**********************************************************************************************
// Test Case ID: TC91359
// Description: Taxes and Fees_CP_BP_RT_To Mexico (Los Cabos)
// Created By : Kartik Chauhan
// Created On : 05-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 10-Apr-2019
//**********************************************************************************************
public class TC91359 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_To_Mexico_Los_Cabos (@Optional("NA")String platform){

        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91359 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        final String ARR_AIRPORT_CODE 	= "SJD";
...
//STEP--4
        ...
        for (int taxCounter = 0; taxCounter < taxList.size(); taxCounter++) {
            ...
            ValidationUtil.validateTestStep("Verifing Tax verbiages To Mexico (Los Cabos) City pair of Tax " + (taxList.get(taxCounter)) + " on Payment Page", taxFlag);
...
//STEP--6
        ...
        for (int taxCounter = 0; taxCounter < taxList.size(); taxCounter++) {
            ...
            //validate for all the taxes in console
            ValidationUtil.validateTestStep("Verifing Tax verbiages To Mexico (Los Cabos) City pair of Tax " + (taxList.get(taxCounter)) + " on Confirmation Page", taxFlag);
