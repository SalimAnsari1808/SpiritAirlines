...
//**********************************************************************************************
// Test Case ID: TC91326
// Description: Taxes and Fees_CP_BP_RT_To Dominican Republic (Santo Domingo)
// Created By : Kartik Chauhan
// Created On : 18-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 18-Apr-2019
//**********************************************************************************************
public class TC91326 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_To_Dominican_Republic_Santo_Domingo (@Optional("NA")String platform){

        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91326 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        final String ARR_AIRPORT_CODE 	= "SDQ";
