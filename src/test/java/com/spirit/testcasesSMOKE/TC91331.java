...
//**********************************************************************************************
// Test Case ID: TC91331
// Description: Taxes and Fees_CP_BP_RT_From Dominican Republic (Santiago)
// Created By : Kartik Chauhan
// Created On : 16-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 16-Apr-2019
//**********************************************************************************************
public class TC91331 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_From_Dominican_Republic_Santiago (@Optional("NA")String platform){
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91331 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        final String DEP_AIRPORT_CODE 	= "STI";
