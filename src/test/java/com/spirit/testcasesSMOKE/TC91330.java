...
//**********************************************************************************************
// Test Case ID: TC91330
// Description: Taxes and Fees_CP_BP_RT_To Dominican Republic (Santiago)
// Created By : Kartik Chauhan
// Created On : 11-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 11-Apr-2019
//**********************************************************************************************
public class TC91330 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_To_Dominican_Republic_Santiago (@Optional("NA")String platform){

        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91330 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        final String ARR_AIRPORT_CODE 	= "STI";
