...
// **********************************************************************************************
//Test Case ID: TC91347
// Description: Taxes and Fees_CP_BP_RT_To Honduras
// Created By : Kartik Chauhan
// Created On : 03-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 04-Apr-2019
// **********************************************************************************************
public class TC91347 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_To_Honduras (@Optional("NA")String platform){
        /**********************Validate on Purchase Page*******************************/
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91347 under SMOKE Suite on " + platform + " Browser"   , true);
        }
...
//STEP--4
        ...
        for (int taxCounter = 0; taxCounter < taxList.size(); taxCounter++) {
            ...
            ValidationUtil.validateTestStep("Verifying Tax verbiages To Honduras City pair of Tax " + (taxList.get(taxCounter)) + " on Payment Page", taxFlag);
        ...
        ValidationUtil.validateTestStep("All Taxes To Honduras is displaying correctly for Roundtrip on Payment Page", true);
...
//STEP--6
        ...
        for (int taxCounter = 0; taxCounter < taxList.size(); taxCounter++) {
            ...
            //validate for all the taxes in console
            ValidationUtil.validateTestStep("Verifing Tax verbiages To Honduras City pair of Tax " + (taxList.get(taxCounter)) + " on Confirmation Page", taxFlag);
        ...
        //Validate All Taxes are displaying correctly
        ValidationUtil.validateTestStep("All Taxes To Honduras is displaying correctly for Roundtrip on Confirmation Page", true);
