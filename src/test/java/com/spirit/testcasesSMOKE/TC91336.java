...
//**********************************************************************************************
// Test Case ID: TC91336
// Description: Taxes and Fees_CP_BP_RT_To Colombia (Cartagena)
// Created By : Kartik Chauhan
// Created On : 12-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 15-Apr-2019
//**********************************************************************************************
public class TC91336 extends BaseClass {
    /******************************************************************************
    ...
    public void Taxes_and_Fees_CP_BP_RT_To_Colombia_Cartagena (@Optional("NA")String platform){

        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91336 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        final String ARR_AIRPORT_CODE 	= "CTG";
