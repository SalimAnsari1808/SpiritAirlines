...
//**********************************************************************************************
// Test Case ID: TC91346
// Description:  Taxes and Fees_CP_BP_RT_From Honduras
// Created By : Kartik Chauhan
// Created On : 17-Apr-2019
// Reviewed By:
// Reviewed On:
//**********************************************************************************************
public class TC91346 extends BaseClass {
    //***********************Navigation to Purchase Page****************************/
    @Parameters ({"platform"})
    @Test (groups = {"BookPath" , "RoundTrip" , "InternationalDomestic" , "Outside21Days" , "Adult" , "Guest" , "Nonstop" , "BookIt" ,
            "CarryOn" , "CheckedBags","NoSeats","ShrtcutBoarding", "CheckInOptions" , "TravelInsuranceBlock" , "MasterCard" , "TaxesAndFee","BagsUI","PaymentUI","ConfirmationUI","ActiveBug"})
    public void Taxes_and_Fees_CP_BP_RT_From_Honduras (@Optional("NA")String platform){
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91346 under SMOKE Suite on " + platform + " Browser"   , true);
        }
...
//STEP--3
        ...
        taxList.add("Departure Fee International");
        taxList.add("Airport User Fee");
