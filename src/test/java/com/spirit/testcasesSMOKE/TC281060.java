...
//**********************************************************************************************
//Test Case ID: TC281060
//Description: 036. E2E_Guest_OW INT Multi ADT_Direct Flight_Bundle It [Tier 3] _Standard_1co 1cb_Any Seats_No Extras CI Web_Credit Card
//Created By :Kartik Chauhan
//Created On : 21-May-2019
//Reviewed By: Salim Ansari
//Reviewed On: 21-May-2019
//**********************************************************************************************
public class TC281060 extends BaseClass {

    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "OneWay" , "DomesticInternational" , "WithIn7Days" , "Adult" , "Guest" , "NonStop" ,
                     "BundleIt" , "DynamicShoppingCartUI" , "CarryOn" , "CheckedBags" , "BagsUI" , "Standard" , "SeatsUI" ,
                     "FlightFlex" , "ShortCutBoarding" , "CheckInOptions" , "OptionalUI" , "PaymentUI" , "MasterCard"})
    public void E2E_Guest_OW_INT_Multi_ADT_Direct_Flight_Bundle_It_Tier_3__Standard_1co_cb_Any_Seats_No_Extras_CI_Web_Credit_Card(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC281060 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        //Verify Option section selected
