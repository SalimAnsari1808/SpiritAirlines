...
//**********************************************************************************************
public class TC369494 extends BaseClass {
    @Parameters ({"platform"})
    @Test(groups = {"BookPath" , "RoundTrip" , "DomesticDomestic" , "Outside21Days" , "Adult" , "FreeSpirit" , "NonStop" , "BookIt" ,
            "CarryOn" , "CheckedBags" , "NoSeats" , "CheckInOptions" , "MasterCard" , "PaymentUI" , "FlightAvailabilityUI"})
    public void Flight_Availability_CP_BP_Logged_FS_RT_Selecting_9DFC_and_STD_flights_Bare_Fare(@Optional("NA")String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC369494 under SMOKE Suite on " + platform + " Browser"   , true);
        }
