...
public class TC90719 extends BaseClass{

    @Parameters ({"platform"})
    @Test(groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "Outside21Days" , "Adult" , "Guest" , "Connecting" , "BookIt","NoBags" ,"BagsUI"})
    public void KEEP_BAG_SAME_FOR_ALL_FLIGHTS_OW_FLIGHT (@Optional("NA")String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC90719 under SMOKE Suite on " + platform + " Browser"   , true);
        }
