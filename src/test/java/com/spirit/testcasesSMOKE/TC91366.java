...
//**********************************************************************************************
// Test Case ID: TC91366
// Description: Taxes and Fees_CP_BP_RT_From Saint Maarten
// Created By : Kartik Chauhan
// Created On : 17-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 17-Apr-2019
//**********************************************************************************************
public class TC91366 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_From_Saint_Maarten (@Optional("NA")String platform){
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91366 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        final String DEP_AIRPORT_CODE 	= "SXM";
...
//STEP--2
        ...
        taxList.add("AN-Pax Screening Fee");
        taxList.add("SXM APT Dept Tax");
        taxList.add("AN-SXM Airport Improvements");
