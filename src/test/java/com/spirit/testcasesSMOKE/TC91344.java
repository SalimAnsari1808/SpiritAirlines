...
//**********************************************************************************************
// Test Case ID: TC91344
// Description:  Taxes and Fees_CP_BP_RT_From Guatemala
// Created By : Kartik Chauhan
// Created On : 17-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 17-Apr-2019
//**********************************************************************************************
public class TC91344 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_From_Guatemala (@Optional("NA")String platform){
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91344 under SMOKE Suite on " + platform + " Browser"   , true);
        }
...
//STEP--3
        ...
        taxList.add("GT Airport Security Fee");
        taxList.add("GT-Departure tax");
