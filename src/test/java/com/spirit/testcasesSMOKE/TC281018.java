...
//**********************************************************************************************
//Test Case ID: TC281018
//Description: E2E_FSMC_RT DOM MAX PAX ALL UMNR_Thru Flight_STD_RT 1CO 1CB_Any Seats_No Extras_CI Web_Credit Card
//Created By : Sunny Sok
//Created On : 26-Apr-2019
//Reviewed By: Salim Ansari
//Reviewed On: 03-May-2019
//**********************************************************************************************
public class TC281018 extends BaseClass {

    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "RoundTrip" , "DomesticDomestic" , "WithIn7Days" ,"Outside21Days", "Child" , "FSMasterCard" , "NonStop" ,
            "BundleIt" , "DynamicShoppingCartUI","CarryOn","CheckedBags" , "Standard" , "FlightFlex" , "ShortCutBoarding" ,
            "AmericanExpress","BagsUI", "OptionalUI","SeatsUI","PaymentUI","ConfirmationUI"})
    public void E2E_FSMC_RT_DOM_MAX_PAX_ALL_UMNR_Thru_Flight_STD_RT_1CO_1CB_Any_Seats_No_Extras_CI_Web_Credit_Card(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC281018 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        final String PASSENGER_TYPE     = "FreeSpiritMasterCardUMNR";
        ...
        final String ARV_SEAT           = "Standard|Standard|Standard|Standard|Standard|Standard|Standard|Standard|Standard";
        ...
        PassengerInfoData passengerInfoData = FileReaderManager.getInstance().getJsonReader().getpassengerInfoByRequest(PASSENGER_TYPE);
