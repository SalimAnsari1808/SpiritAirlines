...
//**********************************************************************************************
// Test Case ID: TC91361
// Description: Taxes and Fees_CP_BP_RT_To Nicaragua
// Created By : Kartik Chauhan
// Created On : 10-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 11-Apr-2019
//**********************************************************************************************
public class TC91361 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_To_Nicaragua (@Optional("NA")String platform){

        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91361 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        final String ARR_AIRPORT_CODE 	= "MGA";
...
//STEP--4
        ...
        taxList.add("NI Arrival Fee (NBX10)");
