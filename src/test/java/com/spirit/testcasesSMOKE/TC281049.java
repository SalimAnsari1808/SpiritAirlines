...
//**********************************************************************************************
public class TC281049 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath" , "Oneway" , "DomesticDomestic" , "Guest" , "Adult" , "Child" , "InfantSeat" , "Within7Days"
                    , "NonStop" , "BookIt" , "NoBags" , "NoSeats" , "CheckInOptions" , "MasterCard"})
    public void  E2E_Guest_OW_Dom_1_ADT_1_Child_0_2_Direct_Flight_No_Bags_No_Seats_No_Extras_CI_Decide_Later_Mastercard (@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC281049 under SMOKE Suite on " + platform + " Browser", true);
        }
