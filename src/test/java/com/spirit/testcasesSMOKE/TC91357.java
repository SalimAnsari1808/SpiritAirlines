...
//**********************************************************************************************
// Test Case ID: TC91357
// Description: Taxes and Fees_CP_BP_RT_To Mexico (Cancun)
// Created By : Kartik Chauhan
// Created On : 04-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 04-Apr-2019
//**********************************************************************************************
public class TC91357 extends BaseClass {
    ...
    public void Taxes_and_Fees_CP_BP_RT_To_Mexico_Cancun (@Optional("NA")String platform){

        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91357 under SMOKE Suite on " + platform + " Browser"   , true);
        }
