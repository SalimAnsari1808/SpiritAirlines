...
//**********************************************************************************************
// Test Case ID: TC91362
// Description: Taxes and Fees_CP_BP_RT_From Panama (Panama City)
// Created By : Kartik Chauhan
// Created On : 15-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 15-Apr-2019
//**********************************************************************************************
public class TC91362 extends BaseClass {
    //***********************Navigation to Purchase Page****************************/
    @Parameters ({"platform"})
    @Test (groups = {"BookPath" , "RoundTrip" , "InternationalDomestic" , "Outside21Days" , "Adult" , "Guest" , "Nonstop" , "BookIt" ,
            "CarryOn" , "CheckedBags","NoSeats", "ShortCutBoarding", "CheckInOptions" , "TravelInsuranceBlock" , "MasterCard" , "TaxesAndFee","BagsUI","PaymentUI","ConfirmationUI" , "ActiveBug"})
    public void Taxes_and_Fees_CP_BP_RT_From_Panama_City (@Optional("NA")String platform){
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91362 under SMOKE Suite on " + platform + " Browser"   , true);
        }
...
//STEP--3
        ...
        taxList.add("PA Airport Security Fee");
        taxList.add("PA Airport Development Tax");
        taxList.add("PA - Airport Departure Tax");
