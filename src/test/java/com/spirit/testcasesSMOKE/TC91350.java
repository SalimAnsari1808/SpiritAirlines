...
//**********************************************************************************************
// Test Case ID: TC91350
// Description: Taxes and Fees_CP_BP_RT_From Haiti (Cap Haitien)
// Created By : Kartik Chauhan
// Created On : 17-Apr-2019
// Reviewed By: Salim Ansari
// Reviewed On: 17-Apr-2019
//**********************************************************************************************
public class TC91350 extends BaseClass {
    //***********************Navigation to Purchase Page****************************/
    @Parameters ({"platform"})
    @Test (groups = {"OutOfExecution" , "BookPath" , "RoundTrip" , "DomesticInternational" , "Outside21Days" , "Adult" , "Guest" , "NonStop" , "BookIt" , "NoBags" , "NoSeats" , "CheckInOptions" , "TravelInsuranceBlock" , "MasterCard" , "TaxesAndFee" , "PaymentUI", "ConfirmationUI"})
    public void Taxes_and_Fees_CP_BP_RT_From_Haiti_Cap_Haitien (@Optional("NA")String platform){
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91350 under SMOKE Suite on " + platform + " Browser"   , true);
        }
        ...
        final String DEP_AIRPORT_CODE 	= "CAP";
...
//STEP--2
        ...
        taxList.add("HT Departure Tax");
        taxList.add("HT-Passenger Facility Charge");
        taxList.add("HT-Security Control Fee");
        taxList.add("KO-Territorial Development Fee");
        ...
        taxList.add("HT TransportationTax");
