...
//**********************************************************************************************
public class TC90944 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"Guest","BookPath","RoundTrip","Child","DomesticDomestic","WithIn7Days","NonStop","BookIt",
    ...
    public void Check_in_Options_CP_BP_Options_Page_NEG_Unaccompanied_Minor(@Optional("NA") String platform) {
    	...
    	if(!platform.equals("NA")) {
    		ValidationUtil.validateTestStep("Starting Test Case ID TC90944 under BAT Suite on " + platform + " Browser"   , true);
    	}
