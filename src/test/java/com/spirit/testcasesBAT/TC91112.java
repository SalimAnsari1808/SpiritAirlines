...
public class TC91112 extends BaseClass {
    @Parameters ({"platform"})
    @Test(groups={"ActiveBug","Guest","BagOTron","DomesticDomestic","WithIn7Days","Adult","NonStop","BookIt","BagsUI"})
    public void CP_Bag_O_Tron_New_TripTest_Scenario (@Optional("NA")String platform){
        //*************************Navigate to Bags Page via FA user*******************/
        //Mention Suite and Browser in reports
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91112 under BAT Suite on " + platform + " Browser", true);
        }
