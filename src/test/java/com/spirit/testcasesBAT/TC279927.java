...
//**********************************************************************************************
public class TC279927 extends BaseClass {

	@Parameters ({"platform"})
	@Test(groups={"Guest","BookPath","OneWay","DomesticDomestic","WithIn7Days","Adult","NonStop","BookIt","NoBags","NoSeats",
                   "FlightFlex","ShortCutBoarding","ShortCutSecurity","CheckInOptions","OptionalUI","DynamicShoppingCartUI"})
	public void Flight_FlexShortcut_Security_and_Shortcut_Boarding (@Optional("NA")String platform) {
		...
		if(!platform.equals("NA")) {
			ValidationUtil.validateTestStep("Starting Test Case ID TC279927 under BAT Suite on " + platform + " Browser"   , true);
		}
