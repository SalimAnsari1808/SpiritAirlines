...
//**********************************************************************************************
public class TC369468 extends BaseClass {

	@Parameters ({"platform"})
	@Test(groups = {"Guest","BookPath","RoundTrip","DomesticDomestic","Outside21Days","Adult","Through","BookIt",
	...
	public void E2E_Guest_RT_DOM_1_ADT_Thru_Flight_Standard_No_Bags_No_Seats_No_Extras_CI_Web_Visa (@Optional("NA")String platform){
    	...
    	if(!platform.equals("NA")) {
    		ValidationUtil.validateTestStep("Starting Test Case ID TC369468 under BAT Suite on " + platform + " Browser"   , true);
    	}
