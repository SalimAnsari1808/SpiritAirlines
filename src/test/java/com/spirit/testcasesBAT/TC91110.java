...
//**********************************************************************************************
public class TC91110 extends BaseClass {
	 ...
	 */
	@Parameters({"platform"})
	@Test(groups = {"Guest","BookPath","OneWay","DomesticDomestic","Outside21Days","FlightAvailabilityUI","NonStop","BookIt","PassengerInformationUI",
					"BagsUI","NoBags","SeatsUI","NoSeats","OptionalUI","CheckInOptions","PaymentUI","Visa"})
	public void Breadcrumb_CP_BP_NEG_Progress_Bar_Flight (@Optional("NA") String platform) {
		...
		if(!platform.equals("NA")) {
			ValidationUtil.validateTestStep("Starting Test Case ID TC91110 under BAT Suite on " + platform + " Browser"   , true);
		}
