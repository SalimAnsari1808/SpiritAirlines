...
//**********************************************************************************************
public class TC90913 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"FreeSpirit","BookPath","RoundTrip","Adult","DomesticDomestic","Outside21Days","Connecting","BookIt","PassengerinfoSignUp"})
    public void Customer_Info_CP_BP_Enroll_as_a_FS_member(@Optional("NA") String platform) {
    	...
    	if(!platform.equals("NA")) {
    		ValidationUtil.validateTestStep("Starting Test Case ID TC90913 under BAT Suite on " + platform + " Browser"   , true);
    	}
