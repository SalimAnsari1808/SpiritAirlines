...
//Test Case ID: TC28677
//Description : Task 28677: 9FC Hotel + Car Upsell DOM RT. Validate prices on Dynamic Shopping Cart on Passenger Information,
...
//*********************************************************************************************************
public class TC28677 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"ActiveBug", "BookPath", "RoundTrip", "DomesticDomestic", "Outside21Days", "Adult", "NineDFC",
    ...
    public void Hotel_Car_Upsell_DOM_RT_Validate_prices_on_Dynamic_Shopping_Cart_on_Passenger_Information_Bags_Seats_and_Options_page_Validating_prices_on_Payment_Confirmation_Reservation_Summary_Itinerary_Receipt_Page_Validate_cannot_be_modified_or_cancelled(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC28677 under Web_Booking_Price_Validation Suite on " + platform + " Browser", true);
        }
