...
//********************************************************************************************************
//Test Case ID: TC28693
//Description : Task 28693: 9FC Flight + Car DOM RT. Validate prices on Dynamic Shoping Cart on Passenger Information,
// Bags, Seats and Options page. Validating prices on Payment, Confirmation, Reservation Summary, Itinerary Receipt
// Page. Validate cannot be modified or cancelled on M
//Created By  : Gabriela
//Created on  : 18-Dec-2019
//Reviewed By : Manasa Tilakraj
//Reviewed On : 26-Dec-2019
//*********************************************************************************************************
public class TC28693 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath", "RoundTrip", "DomesticDomestic", "FlightCar", "Outside21Days", "Adult",
            "NineDFC", "BookIt", "NoBags", "NoSeats", "DynamicShoppingCartUI", "CheckInOptions", "PaymentUI", "Visa"
            , "ConfirmationUI", "ReservationUI", "ItineraryReceiptUI"})
    public void Flight_Car_DOM_RT_Validate_prices_on_Dynamic_Shoping_Cart_on_Passenger_Information_Bags_Seats_and_Options_page_Validating_prices_on_Payment_Confirmation_Reservation_Summary_Itinerary_Receipt_Page_Validate_cannot_be_modified_or_cancelled_onM(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC28693 under Web_Booking_Price_Validation Suite on " + platform + " Browser", true);
        }
