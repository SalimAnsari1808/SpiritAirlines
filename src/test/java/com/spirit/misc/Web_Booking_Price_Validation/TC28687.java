...
//********************************************************************************************************
//Test Case ID: TC28687
//Description : Task 28687: FS Flight + Hotel INT-DOM RT. Validate prices on Dynamic Shopping Cart on Passenger Information,
//              Bags, Seats and Options page. Validating prices on Payment, Confirmation, Reservation Summary, Itinerary
//              Receipt Page. Validate cannot be modified or cancelled
// Created By : Gabriela
//Created on  : 23-Dec-2019
//Reviewed By : Manasa Tilakraj
//Reviewed On : 26-Dec-2019
//*********************************************************************************************************
public class TC28687 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath", "RoundTrip", "InternationalDomestic","FlightHotel", "Outside21Days", "Adult",
                    "FreeSpirit", "BookIt", "NoBags", "NoSeats","HotelsUI", "CheckInOptions", "PaymentUI", "Visa",
                    "DynamicShoppingCartUI", "ConfirmationUI", "ReservationUI", "ItineraryReceiptUI"})
    public void FS_Flight_Hotel_INT_DOM_RT_Validate_prices_on_Dynamic_Shoping_Cart_on_Passenger_Information_Bags_Seats_and_Options_page_Validating_prices_on_Payment_Confirmation_Reservation_Summary_Itinerary_Receipt_Page_Validate_cannot_be_modified_or_cancelled(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC28687 under Web_Booking_Price_Validation Suite on " + platform + " Browser", true);
        }
        ...
        try {
            ...
            ValidationUtil.validateTestStep("Validating departure price ($"+depPricePaid1+") + the returning price ($"+retPricePaid1+") are matching with the total paid on Itinerary Page",
                    totalPaid1 == Math.rint((depPricePaid1 + retPricePaid1 )*100)/100);
