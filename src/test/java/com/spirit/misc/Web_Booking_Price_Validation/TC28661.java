...
//**********************************************************************************************
//Test Case ID: TC28661
//Description: 9FC Hote Upsell DOM RT. Validate prices on Dynamic Shoping Cart on Passenger Information, Bags, Seats and Options page.  Validating prices on Payment, Confirmation, Reservation Summary, Itinerary Receipt Page. Validate cannot be modified or cancelled on MT
...
public class TC28661 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath", "RoundTrip", "Domestic", "Flight", "WithIn7Days", "Adult", "9DFC",
            "NonStop", "BookIt", "NoBags", "NoSeats", "CheckInOptions", "Visa", "ReservationUI" , "CheckIn"})
    public void NineFC_Hote_Upsell_DOM_RT_Validate_prices_on_Dynamic_Shoping_Cart_on_Passenger_Information_Bags_Seats_and_Options_page_Validating_prices_on_Payment_Confirmation_Reservation_Summary_Itinerary_Receipt_Page_Validate_cannot_be_modified_or_cancelled_on_MT(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC28661 under Web_Booking_Price_Validation Suite on " + platform + " Browser", true);
        }
        ...
        if (scenarioContext.getContext(Context.AVAILABILITY_FS_TOTAL_PRICE) != null) {
            totalFlightPrice += String.valueOf(scenarioContext.getContext(Context.AVAILABILITY_FS_TOTAL_PRICE));
        }else{
            totalFlightPrice += String.valueOf(scenarioContext.getContext(Context.AVAILABILITY_9DFC_TOTAL_PRICE));
        }
        ...
        ValidationUtil.validateTestStep("Validating Flight price and Itinerary Total Amount matches on Passenger Page: \n flightPricePassenger = "
                ...
                flightPricePassenger.equals(ItineraryTotalPassenger) && totalFlightPrice.equals(ItineraryTotalPassenger));
        ...
        ValidationUtil.validateTestStep("Validating Flight price and Itinerary Total Amount matches on Bags Page: \n flightPriceBag = "
                ...
                flightPriceBag.equals(ItineraryTotalBag) && totalFlightPrice.equals(ItineraryTotalBag));
        ...
        ValidationUtil.validateTestStep("Validating Flight price and Itinerary Total Amount matches on Seats Page: \n flightPriceSeats = "
                ...
                flightPriceSeats.equals(ItineraryTotalSeats) && totalFlightPrice.equals(ItineraryTotalSeats));
        ...
        ValidationUtil.validateTestStep("Validating Flight price and Itinerary Total Amount matches on Options Page: \n flightPriceOptions = "
                ...
                flightPriceOptions.equals(ItineraryTotalOptions) && totalFlightPrice.equals(ItineraryTotalOptions));
