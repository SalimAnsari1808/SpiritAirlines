...
//Test Case ID: TC28675
//Description : Task 28675: FS Hotel + Car Upsell DOM RT. Validate prices on Dynamic Shoping Cart on Passenger Information,
// Bags, Seats and Options page. Validating prices on Payment, Confirmation, Reservation Summary, Itinerary Receipt Page.
// Validate cannot be modified or cancelled
// Created By : Gabriela
//Created on  : 20-Dec-2019
//Reviewed By : Un Fai Chan
//Reviewed On : 26-Dec-2019
//*********************************************************************************************************
public class TC28675 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"ActiveBug","BookPath", "RoundTrip", "DomesticDomestic", "Outside21Days", "Adult", "FreeSpirit",
                    "CarsUI", "HotelsUI", "BookIt", "NoBags", "NoSeats", "DynamicShoppingCartUI", "Cars", "CheckInOptions",
                    "PaymentUI", "Visa", "ConfirmationUI", "ReservationUI", "ItineraryReceiptUI", "Hotels"})
    public void FS_Hotel_Car_Upsell_DOM_RT_Validate_prices_on_Dynamic_Shopping_Cart_on_Passenger_Information_Bags_Seats_and_Options_page_Validating_prices_on_Payment_Confirmation_Reservation_Summary_Itinerary_Receipt_Page_Validate_cannot_be_modified_or_cancelled(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC28675 under Web_Booking_Price_Validation Suite on " + platform + " Browser", true);
        }
