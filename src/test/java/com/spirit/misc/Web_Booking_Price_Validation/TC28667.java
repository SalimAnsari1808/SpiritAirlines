...
//Test Case ID: TC28667
//Description : Task 28667: FS Car Upsell DOM RT. Validate prices on Dynamic Shoping Cart on Passenger Information, Bags,
// Seats and Options page. Validating prices on Payment, Confirmation, Reservation Summary, Itinerary Receipt Page.
...
//*********************************************************************************************************
public class TC28667 extends BaseClass {
    ...
    public void FS_Car_Upsell_DOM_RT_Validate_prices_on_Dynamic_Shoping_Cart_on_Passenger_Information_Bags_Seats_and_Options_page_Validating_prices_Payment_Confirmation_Reservation_Summary_Itinerary_Receipt_Page_Validate_cannot_be_modified_or_cancelled_on_MT(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC28667 under Web_Booking_Price_Validation Suite on " + platform + " Browser", true);
        }
