...
//Test Case ID: TC28679
//Description : Task 28679: FS Hotel + Car Upsell INT-DOM RT. Validate prices on Dynamic Shoping Cart on Passenger Information, Bags, Seats and Options page. Validating prices on Payment, Confirmation, Reservation Summary, Itinerary Receipt Page. Validate cannot be modified or cance
// Created By : Gabriela
//Created on  : 20-Dec-2019
//Reviewed By : Un Fai Chan
//Reviewed On : 26-Dec-2019
//*********************************************************************************************************
public class TC28679 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"ActiveBug", "BookPath", "RoundTrip", "InternationalDomestic", "Outside21Days", "Adult","FreeSpirit",
            "CarsUI", "BookIt", "NoBags", "NoSeats", "DynamicShoppingCartUI", "Cars","CheckInOptions",
            "PaymentUI","Visa", "ConfirmationUI", "ReservationUI", "ItineraryReceiptUI","Hotels","HotelsUI"})
    public void FS_Hotel_Car_Upsell_INT_DOM_RT_Validate_prices_on_Dynamic_Shoping_Cart_on_Passenger_Information_Bags_Seats_and_Options_page_Validating_prices_on_Payment_Confirmation_Reservation_Summary_Itinerary_Receipt_Page_Validate_cannot_be_modified_or_cance(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC28679 under Web_Booking_Price_Validation Suite on " + platform + " Browser", true);
        }
