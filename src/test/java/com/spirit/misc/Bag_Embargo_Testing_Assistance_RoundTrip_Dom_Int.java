...
public class Bag_Embargo_Testing_Assistance_RoundTrip_Dom_Int extends BaseClass {
    ...
    public void Bag_Embargo_Test(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID Bag_Embargo_Testing_Assistance_RoundTrip_Dom_Int under GoldFinger Suite on " + platform + " Browser", true);
        }
