...
public class PRODTC89931 extends BaseClass {
    ...
    public void E2E_Guest_MC_DOM_1_ADT_1_Child_15_18_Connecting_Flight_Standard_No_Bags_No_Seats_SS_SB_FF_CI_Web_Mastercard(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC89931 under PRODUCTION Suite on " + platform + " Browser", true);
        }
