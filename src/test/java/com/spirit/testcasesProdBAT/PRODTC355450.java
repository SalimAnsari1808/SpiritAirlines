...
//**********************************************************************************************
public class PRODTC355450 extends BaseClass {
    /******************************************************************************
    ...
    public void E2E_Guest_OW_DOM_1_ADT_1_INFT_Lap_Tier_3_Thru_Flight_Military_Bundle_bags_Bundle_Seats_No_Extras_CI_Web_Credit_Card (@Optional("NA")String platform){
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC355450 under PRODUCTION Suite on " + platform + " Browser"   , true);
        }
