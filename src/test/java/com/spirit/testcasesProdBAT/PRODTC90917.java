...
public class PRODTC90917 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups="Production")

    public void Customer_Info_CP_BP_Try_to_use_already_existing_FS_email(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC90917 under PRODUCTION Suite on " + platform + " Browser", true);
        }
