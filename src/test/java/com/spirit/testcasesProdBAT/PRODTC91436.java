...
//**********************************************************************************************
public class PRODTC91436 extends BaseClass {
    ...
    public void CP_BP_Payment_Page_Travel_Guard_PR_Resident(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC91436 under PRODUCTION Suite on " + platform + " Browser", true);
        }
