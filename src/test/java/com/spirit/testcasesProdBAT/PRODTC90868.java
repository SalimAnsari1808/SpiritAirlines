...
//**********************************************************************************************
public class PRODTC90868 extends BaseClass {
    ...
    public void Misc_CP_MT_SinglePAX_Options_Verify_seats_tag_is_correct(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC90868 under PRODUCTION suite on " + platform + " Browser", true);
        }
