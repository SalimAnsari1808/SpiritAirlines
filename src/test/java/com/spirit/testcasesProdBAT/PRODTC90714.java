...
public class PRODTC90714 extends BaseClass{
	...
	public void ADD_BAG_WITH_PLUS_OR_MINUS (@Optional("NA")String platform) {
		...
		if(!platform.equals("NA")) {
			ValidationUtil.validateTestStep("Starting Test Case ID PRODTC90714 under PRODUCTION Suite on " + platform + " Browser"   , true);
		}
