...
public class PRODTC90738 extends BaseClass {
    ...
    public void CP_BP_Payment_Page_Your_Itinerary_Content_Block(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC90738 under PRODUCTION Suite on " + platform + " Browser", true);
        }
