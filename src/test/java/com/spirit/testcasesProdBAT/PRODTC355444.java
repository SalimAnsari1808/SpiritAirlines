...
//**********************************************************************************************
public class PRODTC355444 extends BaseClass {
    ...
    public void  E2E_Guest_OW_DOM_MAX_PAX_MIX_Connecting_Flight_Standard_Bundle_Bags_Bundle_Seats_SS_CI_Web_Credit_Card(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC355444 under PRODUCTION Suite on " + platform + " Browser"   , true);
        }
