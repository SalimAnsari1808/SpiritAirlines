...
//**********************************************************************************************
public class PRODTC90001 extends BaseClass {
    ...
    public void E2E_Guest_OW_DOM_1_ADT_Thru_Flight_Standard_Bundle_It_Bags_Thrills_Seats_No_Extras_CI_Web_Credit_Card(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC90001 under PRODUCTION Suite on " + platform + " Browser", true);
        }
