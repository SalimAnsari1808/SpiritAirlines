...
//**********************************************************************************************
public class PRODTC90728 extends BaseClass{
    ...
    public void Dynamic_Shopping_Cart_Bags_Caret_Dropdown_WireFrame(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC90728 under PRODUCTION Suite on " + platform + " Browser" , true);
        }
        ...
        final String BACKGROUND_COLOR          = "rgba(239, 239, 239, 1)";
        ...
        ValidationUtil.validateTestStep("Verify A Grey text block",
                getDriver().findElement(By.xpath("//div[contains(@class,'total-cost')]")).getCssValue("background-color"),BACKGROUND_COLOR);
