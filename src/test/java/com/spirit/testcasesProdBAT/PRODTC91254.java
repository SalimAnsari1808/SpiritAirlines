...
public class PRODTC91254 extends BaseClass {
    ...
    public void My_Account_CP_FS_Error_Message_for_Login_Email_is_Required(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC91254 under PRODUCTION Suite on " + platform + " Browser", true);
        }
