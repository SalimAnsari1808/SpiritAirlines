...
public class PRODTC90446 extends BaseClass {
    @Parameters({"platform"})
    ...
    public void Nine_DFC_OW_DOM_1_ADT_Thru_Flight_STD_1CO_1CB_Any_Seats_No_Extras_CI_Web_Credit_Card (@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC90446 under PRODUCTION Suite on " + platform + " Browser", true);
        }
