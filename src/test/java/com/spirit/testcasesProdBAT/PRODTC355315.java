...
//**********************************************************************************************
public class PRODTC355315 extends BaseClass {
    ...
    public void E2E_Guest_OW_Dom_0_ADT_1_UMNR_Thru_Flight_No_Bags_No_Seats_No_Extras_CI_AMEX(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC355315 under PRODUCTION Suite on " + platform + " Browser"   , true);
        }
