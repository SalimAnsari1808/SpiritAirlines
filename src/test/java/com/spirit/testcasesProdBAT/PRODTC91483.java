...
//**********************************************************************************************
public class PRODTC91483 extends BaseClass {
    ...
    public void Flight_Only_1_CHD_14_years_old_on_Domestic_Connecting_Flights(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC91483 in PRODUCTION Suite on " + platform + " Browser"   , true);
        }
