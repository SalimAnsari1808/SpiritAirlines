...
public class PRODTC91426 extends BaseClass {
    ...
    public void CP_BP_Payment_Page_Itinerary_RT_Layover_Validate_EDIT_Options_link(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC91426 under PRODUCTION Suite on " + platform + " Browser", true);
        }
...
//-- Step 3:
        ...
        for (int count = 0; count < layoverInfoPayment.size(); count++) {
            ValidationUtil.validateTestStep("alidating right layover information is displayed",
                    layoverInfoPayment.get(count).toUpperCase(), layoverInfo.get(count).toUpperCase());
        }
