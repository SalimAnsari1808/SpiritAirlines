...
//**********************************************************************************************
public class PRODTC281074 extends BaseClass{
    @Parameters({"platform"})
    ...
    public void E2E_Guest_OW_DOM_1_ADT_SW_Change_Date_Connecting_Flight_Standard_No_Bags_BFS_Seats_No_Extras_CI_Web_Credit_Card(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC281074 under PRODUCTION Suite on " + platform + " Browser" , true);
        }
