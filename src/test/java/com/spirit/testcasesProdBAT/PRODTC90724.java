...
public class PRODTC90724 extends BaseClass{
    ...
    public void Dynamic_Shopping_Cart_Bags_Page_WireFrame(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC90724 under PRODUCTION Suite on " + platform + " Browser" , true);
        }
