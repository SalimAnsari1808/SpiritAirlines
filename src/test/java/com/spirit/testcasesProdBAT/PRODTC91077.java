...
public class PRODTC91077 extends BaseClass {
    @Parameters({"platform"})
    ...
    public void Customer_Info_CP_BP_Verify_15_years_or_older_UMNR_is_treated_as_an_adult(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC91077 in PRODUCTION Suite on " + platform + " Browser"   , true);
        }
