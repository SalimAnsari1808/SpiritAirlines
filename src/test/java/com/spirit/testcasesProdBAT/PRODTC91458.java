...
public class PRODTC91458 extends BaseClass {
    ...
    public void CP_CI_Validating_Forms_of_Payment_CreditCard(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC91458 under PRODUCTION Suite on " + platform + " Browser", true);
        }
