...
//**********************************************************************************************
public class PRODTC90855 extends BaseClass {
    ...
    public void Search_Widget_CP_BP_UMNR_DOM_INT(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC90855 under PRODUCTION Suite on " + platform + " Browser"   , true);
        }
