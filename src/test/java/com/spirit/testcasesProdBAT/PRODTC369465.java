...
public class PRODTC369465 extends BaseClass {
    ...
    public void dynamic_Shopping_Cart_Bags_Page_Generic_for_all_Booking_Types (@Optional("NA")String platform)
    {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PROTC369465 under PRODUCTION Suite on " + platform + " Browser"   , true);
        }
...
//Step -- 7
        //click on edit on the bags section on shopping cart , validae redirected to the bags page
...
//Step -- 8
        ...
        WaitUtil.untilTimeCompleted(2000);
        //validate the fligh price from original flightprice
...
//Step -- 9
        ...
        //validate pop-up
        WaitUtil.untilTimeCompleted(2000);
        ValidationUtil.validateTestStep("The Edit FLight modal is dislayed",
