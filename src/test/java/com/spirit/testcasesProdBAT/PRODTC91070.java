...
//**********************************************************************************************
public class PRODTC91070 extends BaseClass{
    @Parameters({"platform"})
    ...
    public void Customer_Info_CP_BP_9DFC_logging_out_using_why_cant_you_edit_your_name_link(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC91070 under PRODUCTION Suite on " + platform + " Browser", true);
        }
