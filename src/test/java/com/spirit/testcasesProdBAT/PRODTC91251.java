...
public class PRODTC91251 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups="Production")

    public void CP_Header_Ingresar_Login_FS_number(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC91251 under PRODUCTION Suite on " + platform + " Browser", true);
        }
