...
//**********************************************************************************************
public class PRODTC280301 extends BaseClass {
    ...
    public void E2E_9DFC_OW_DOM_1_ADT_1_Child_2_DirectFlight_EmotionalSupportAnimal_ThrillBags_Included_seats_SB_and_FF_CI_web_TG_and_mastercard (@Optional("NA") String platform){
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC280301 under PRODUCTION Suite on " + platform + " Browser", true);
        }
        //Home Page Constant Values
        final String LANGUAGE         = "English";
        final String JOURNEY_TYPE     = "Flight";
        final String EMAIL_LOGIN      = "ProdNineDFCEmail";
