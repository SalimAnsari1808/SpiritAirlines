...
// **********************************************************************************************
public class PRODTC90721 extends BaseClass {
    @Parameters({"platform"})
    ...
    public void BAGS_CP_BP_OW_DOM_1PAX_VALIDATE_VERBIAGE_ON_FOOTER(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC90721 under PRODUCTION Suite on " + platform + " Browser", true);
        }
