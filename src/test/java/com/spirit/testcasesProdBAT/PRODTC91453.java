...
//**********************************************************************************************
public class PRODTC91453 extends BaseClass{
    ...
    public void CP_BP_Payment_Page_9DF_bundle(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC91453 under PRODUCTION Suite on " + platform + " Browser" , true);
        }
