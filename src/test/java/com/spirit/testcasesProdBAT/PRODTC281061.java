...
//**********************************************************************************************
public class PRODTC281061 extends BaseClass {
    ...
    public void E2E_Guest_OW_DOM_0_ADT_1_UMNR_Thru_Flight_Bundle_It_Tier_3_Standard_1co_1cb_Any_Seats_No_Extras_CI_Web_Mastercard(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC281061 under PRODUCTION Suite on " + platform + " Browser"   , true);
        }
