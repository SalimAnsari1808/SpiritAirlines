...
//**********************************************************************************************
public class PRODTC91384 extends BaseClass{
    @Parameters ({"platform"})
    ...
    public void ADD_SPORTING_EQUIPMENT_WITH_PLUS_OR_MINUS_SURFBOARDS(@Optional("NA")String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC91384 under PRODUCTION Suite on " + platform + " Browser"   , true);
        }
