...
public class PRODTC90764 extends BaseClass {
    ...
    public void Customer_Info_CP_BP_NEG_Have_two_PAX_with_the_same_name(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC90764 under PRODUCTION suite on " + platform + " Browser", true);
        }
