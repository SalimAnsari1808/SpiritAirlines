...
public class PRODTC89929 extends BaseClass {
    ...
    public void E2E_Guest_MC_DOM_1_ADT_1_Child_5_15_Direct_Fligt_Standard_No_Bags_No_Seats_SS_SB_FF_CI_Airport_Amex(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC89929 under PRODUCTION Suite on " + platform + " Browser", true);
        }
