...
//**********************************************************************************************
public class PRODTC91439 extends BaseClass {
    @Parameters({"platform"})
    ...
    public void CP_BP_Payment_Page_9DFC_savings_banner(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC91439 under PRODUCTION Suite on " + platform + " Browser", true);
        }
