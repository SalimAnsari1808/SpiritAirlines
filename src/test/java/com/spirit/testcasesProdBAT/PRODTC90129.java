...
public class PRODTC90129 extends BaseClass {
    ...
    public void E2E_Guest_MC_DOM_1_ADT_1_INFT_Lap_SW_Change_Month_and_Day_Book_It_Tier_1_Direct_Flight_Own_Wheel_Chair_Dry_Battery_1_Carry_On_1_Checked_Any_Seats_No_Extras_CI_Web_Visa(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC90129 under PRODUCTION Suite on " + platform + " Browser", true);
        }
        ...
        JSExecuteUtil.clickOnElement(getDriver(),pageObjectManager.getHomePage().getSearchFlightButton().get(0));
