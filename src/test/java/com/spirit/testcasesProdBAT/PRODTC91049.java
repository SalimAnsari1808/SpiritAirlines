...
public class PRODTC91049 extends BaseClass {
    @Parameters({"platform"})
    ...
    public void Flight_Availability_CP_BP_Flight_Only_Month_Calendar_Dollars_View_Wireframe(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC91049 under PRODUCTION Suite on " + platform + " Browser", true);
        }
        ...
        final String FONT_BLUE          = "rgba(0,115,230,1)";
