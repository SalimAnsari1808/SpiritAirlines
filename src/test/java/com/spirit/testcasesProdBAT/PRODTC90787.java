...
//**********************************************************************************************
public class PRODTC90787 extends BaseClass {
  ...
  public void BAGS_CP_BP_OW_DOM_1PAX_VALIDATE_BAG_TOTAL_BAR(@Optional("NA") String platform) {
    if (!platform.equals("NA")) {
      ValidationUtil.validateTestStep("Starting Test Case ID PRODTC90787 under PRODUCTION Suite on " + platform + " Browser", true);
    }
     ...
     ***************************************************/
//Step -- 4
    final String totalDueContainerBarColorExpected  = "rgba(0, 0, 0, 1)";
    final String bagsTotalTextColorExpected         = "rgba(255, 255, 255, 1)";
