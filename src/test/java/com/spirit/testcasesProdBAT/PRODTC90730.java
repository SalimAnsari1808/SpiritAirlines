...
public class PRODTC90730 extends BaseClass{
    ...
    public void Dynamic_Shopping_Cart_Options_Caret_Dropdown_WireFrame(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC90730 under PRODUCTION Suite on " + platform + " Browser" , true);
        }
