...
// Reviewed On:
// **********************************************************************************************
public class PRODTC90752 extends BaseClass {
    @Parameters ({"platform"})
    ...
    public void BAGS_CP_BP_OW_DOM_1PAX_VALIDATE_VERBIAGE_IN_BAGS_BOX (@Optional("NA")String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC90752 under PRODUCTION Suite on " + platform + " Browser", true);
        }
