...
public class PRODTC91247 extends BaseClass {
    ...
    public void CP_Header_9_FC(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PORDTC91247 under PRODUCTION Suite on " + platform + " Browser", true);
        }
