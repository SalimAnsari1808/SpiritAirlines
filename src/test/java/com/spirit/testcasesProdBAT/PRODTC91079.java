...
public class PRODTC91079 extends BaseClass {
    ...
    public void Customer_Info_CP_BP_NEG_Enroll_as_a_FS_member_invalid_input(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC91079 under PRODUCTION suite on " + platform + " Browser", true);
        }
