...
//**********************************************************************************************
public class PRODTC355435 extends BaseClass {
    ...
    public void E2E_Guest_OW_Dom_1_UMNR_Direct_Flight_Standard_Bundle_Bags_Bundle_Seats_No_Extras_CI_Web_Credit_Card(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC355435 under PRODUCTION Suite on " + platform + " Browser"   , true);
        }
