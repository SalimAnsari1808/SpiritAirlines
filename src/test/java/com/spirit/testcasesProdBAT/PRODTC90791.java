...
// **********************************************************************************************
public class PRODTC90791 extends BaseClass {
    @Parameters({"platform"})
    ...
    public void Flight_Availability_CP_BP_Flight_Only_Stops_link_populating_the_Flight_Information_popup_Wireframe_and_Functionality(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC90791 under PRODUCTION Suite on " + platform + " Browser", true);
        }
