...
//**********************************************************************************************
public class PRODTC90766 extends BaseClass {
    ...
    public void Customer_Info_CP_BP_Have_two_PAX_with_the_same_name_but_with_SR_and_JR_suffix(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC90766 under PRODUCTION Suite on " + platform + " Browser", true);
        }
