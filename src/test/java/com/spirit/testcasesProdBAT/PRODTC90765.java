...
//**********************************************************************************************
public class PRODTC90765 extends BaseClass{
    @Parameters({"platform"})
    ...
    public void Home_Page_CP_BP_Marketing_Tiles(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID PRODTC90765 under PRODUCTION Suite on " + platform + " Browser", true);
        }
