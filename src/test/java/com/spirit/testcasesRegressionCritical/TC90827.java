...
//**********************************************************************************************
//Test Case ID: TC90827
//Description: Task 22941: 31257 Search Widget_CP_BP_Flight+Car 1 Pax with INF with seat
//Created By: Gabriela
...
public class TC90827 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"BookPath" , "FlightCar" , "DomesticDomestic" , "Outside21Days" , "Adult" , "InfantSeat" ,"Guest", "HomeUI"})
    public void Search_Widget_CP_BP_Flight_Car_1_Pax_with_INF_with_seat(@Optional("NA") String platform) {

        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC90827 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
        ...
        final String DEP_DATE 			= "36";
        final String ARR_DATE 			= "37";
        ...
        /**************************Home Page Methods********************************/
//-- Step 10: Access SkySales testing environment
...
//-- Step 3: Add 1 Adult and 1 infant w/seat
...
//-- Step 9: Do not complete booking. This test is only to validate you get the young traveler popup in a vacation path
    }
}