...
//**********************************************************************************************
//TODO: [IN:23931] Prod: CP: CI : Boarding Pass: "Bag Drop" time and "Self Bag-Tag" time is displaying the same time as boarding time
//Test Case ID: TC91107
//Description: BordingPass_CP_CI_INT_ Verify self tagging  message for Self-Tagging airport to Bag Drop Airport
...
public class TC91107 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"CheckIn" , "RoundTrip" , "DomesticColombia" , "WithIn7Days" , "Adult" , "FreeSpirit" , "NonStop" ,
                    "BookIt" , "CheckedBags" , "NoSeats" , "CheckInOptions" , "Visa" , "BoardingPassUI","ActiveBug"})
    public void BordingPass_CP_CI_INT_Verify_self_tagging_message_for_Self_Tagging_airport_to_Bag_Drop_Airport(@Optional("NA") String platform) {

        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91107 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
...
//Step 4: Validate user lands on the boarding pass page
        ...
        ValidationUtil.validateTestStep("Verify user reached to Boarding Pass Page", getDriver().getCurrentUrl().contains(BOARDING_PASS_URL));
...
//Step 6: Validate the Self Bag Tag airport verbiage is correct
        String bagDropExpectedTime = getDesiredTime(pageObjectManager.getBoardingPassPage().getDepartsCityTimeText().get(0).getText().trim() , -1 , 0-30 , "HH:mm");
...
//Step 7: Validate top left quadrant
        ...
        final String DEPART_CITY_CODE       = "FLL";
        final String DEPART_CITY            = "Fort Lauderdale, FL";
        final String ARRIVE_CITY_CODE       = "CUN";
        final String ARRIVE_CITY            = "Cancun, Mexico";
...
//Step--10
        //validate that all information at the bottom right of the boarding pass is correct
