...
//**********************************************************************************************
//Test Case ID: TC280876
//Description: Task 24298: 31696 621. E2E_FSMC_OW DOM 1 ADT 2 Children Miles_SW Change PAX 1 ADT 2 INFT, Thrills Combo, Connecting_Standard_Thrills Bags_Trills Seats_No Extras CI Web_Reservation Credit, Credit Card
//Created By: Gabriela
...
public class TC280876 extends BaseClass {
    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "OneWay" , "Miles" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "InfantSeat" , "InfantLap" ,
                     "FSMasterCard" , "NewFlightSearch" , "Connecting" , "BundleIt" , "CarryOn" , "CheckedBags" , "Standard" ,
                     "FlightFlex" , "ShortCutBoarding" , "ReservationCredit" , "Discover","OptionalUI","PaymentUI","ConfirmationUI"})
    public void  E2E_FSMC_OW_DOM_1_ADT_2_Children_Miles_SW_Change_PAX_1_ADT_2_INFT_Thrills_Combo_Connecting_Standard_Thrills_Bags_Trills_Seats_No_Extras_CI_Web_Reservation_Credit_Credit_Card(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC280876 under REGRESSION_CRITICAL Suite on " + platform + " Browser", true);
        }
        ...
        if(TestUtil.verifyElementDisplayed(pageObjectManager.getMemberEnrollmentPage().getSecurityCodeTextBox())){
