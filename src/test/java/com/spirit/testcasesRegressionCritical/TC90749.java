...
public class TC90749 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"BookPath" , "RoundTrip" , "DomesticDomestic" , "WithIn7Days" ,"WithIn21Days", "Adult" , "Guest" , "NonStop" , "BookIt" , "NoBags" , "NoSeats" , "CheckInOptions" , "AmericanExpress" , "PaymentUI"})
    public void CP_BP_Payment_Page_Terms_Conditions(@Optional("NA") String platform) {

        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC90749 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
