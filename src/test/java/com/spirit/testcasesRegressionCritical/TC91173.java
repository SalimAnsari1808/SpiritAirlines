...
// **********************************************************************************************
// TestCase :   TC91173
// Description: CP_CI_Car Modal_Reserve a car_UMNR
//Created By:   Salim Ansari
//Created On:   07-Aug-2019
//Reviewed By:  Kartik Chauhan
//Reviewed On:  07-Aug-2019
//**********************************************************************************************
public class TC91173 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups={"CarsUI", "CheckIn", "RoundTrip", "DomesticDomestic", "WithIn7Days", "Child","Guest", "NonStop","BookIt","NoBags","NoSeats", "TravelInsuranceBlock", "MasterCard","BoardingPassUI"})

    public void CP_CI_Car_Modal_Reserve_a_car_UMNR (@Optional("NA")String platform){
        //mention the browser
        if(!platform.equals("NA")){
            ValidationUtil.validateTestStep("Starting Test Case ID TC91173 under REGRESSION-CRITICAL suite on " + platform +" Browser", true);
        }
...
//Step1
        ...
        //Dverify Rental Car popup will not appear
        ValidationUtil.validateTestStep("Verify Buy a Rental Car popup is not displayed on Check-In path",
        ...
        ValidationUtil.validateTestStep("Verify user verify This is not a boarding pass verbiage on  Boarding Pass Page",
                TestUtil.verifyElementDisplayed(pageObjectManager.getBoardingPassPage().getNotBoardingPassText()));
