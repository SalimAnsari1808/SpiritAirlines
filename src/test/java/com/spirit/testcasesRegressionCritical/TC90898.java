...
//**********************************************************************************************
//Test Case ID: TC90898
//Description: CP_CI_Online Check In page full validation_Add Service Animal
//Created By: Kartik chauhan
//Created On: 18-July-2019
//Reviewed By: Salim Ansari
//Reviewed On: 19-July-2019
//**********************************************************************************************
public class TC90898 extends BaseClass {
    ...
    public void CP_CI_Online_Check_In_page_full_validation_Add_Service_Animal(@Optional("NA") String platform) {
        //***************************Navigate to Reservation Page***********************/
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC90898 under REGRESSION-CRITICAL Suite on " + platform + " Browser"   , true);
        }
