...
//**********************************************************************************************
//Test Case ID: TC91464
//Description : CP_CI_Payment Page_9DFC_use fraudulent CC
//Created By : Sunny Sok
//Created On : 08-JUL-2019
//Reviewed By: Salim Ansari
//Reviewed On: 17-JUL-2019
//**********************************************************************************************
//BUG: INC24308 CP: CI: Options Page: Travel Guard CTA Pops Up when Travel Guard already purchased through web
/**10/21/19 test case passed, removed active bug tag**/

public class TC91464 extends BaseClass{

    @Parameters({"platform"})
    @Test(groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "NineDFC" , "NonStop" , "BookIt" , "PassengerInfoSSR" , "CarryOn" , "CheckedBags" , "Standard","ShortCutBoarding", "CheckInOptions" , "MasterCard" ,"TravelInsuranceBlock", "PaymentUI","AddEditBags"})
    public void CP_CI_Payment_Page_9DFC_use_fraudulent_CC(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91464 under REGRESSION-CRITICAL Suite on " + platform + " Browser" , true);
        }
        ...
        final String RESERVATION_URL    = "check-in/reservation-summary";
        ...
        String cardError = pageObjectManager.getCommon().getIBlockVerbiageText().getText().replaceAll("[^\\p{ASCII}]", "");
        ValidationUtil.validateTestStep("User Verify error message for Hot Card", FRAUD_CARD_ERROR , cardError);
