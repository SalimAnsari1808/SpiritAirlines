...
//**********************************************************************************************
//Test Case ID: TC91267
//Description: Task 24746: 35131 CP_Header_Comuníquese con Nosotros_Link
//Created By: Gabriela
...
public class TC91267 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups={"HomeUI", "Spanish", "Header"})

    public void CP_Header_Comuníquese_con_Nosotros_Link(@Optional("NA") String platform) {

        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91267 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
        ...
        final String CONTACT_URL            = "spirit.com/contact-us";
...
//-- Step 3: In the Header of the Home Page click on the link "COMUNÍQUESE CON NOSOTROS" link
        WaitUtil.untilTimeCompleted(1000);
        pageObjectManager.getHeader().getContactUsLink().click();
        WaitUtil.untilPageLoadComplete(getDriver());
        WaitUtil.untilTimeCompleted(1200);
        ValidationUtil.validateTestStep("Validating user is taken to the right URL", getDriver().getCurrentUrl(),CONTACT_URL);
    }
}