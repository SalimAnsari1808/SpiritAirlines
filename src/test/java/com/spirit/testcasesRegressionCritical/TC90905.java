...
//**********************************************************************************************
//Test Case ID: TC90905
//Description: CP_CI_Online Check In page full validation_Add Disability Seating
//Created By:  Kartik chauhan
//Created On:  22-July-2019
//Reviewed By: Salim Ansari
//Reviewed On: 22-July-2019
//**********************************************************************************************
public class TC90905 extends BaseClass {
    ...
    public void CP_CI_Online_Check_In_page_full_validation_Add_Disability_Seating(@Optional("NA") String platform) {
        //*************************Navigate to Reservation Page**************************/
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC90905 under REGRESSION-CRITICAL Suite on " + platform + " Browser"   , true);
        }
...
//        final String TRAVEL_GUARD       = "Required";
        ...
        //Reservation Summary Page OCnstant
        final String DISABILITY_SEATING_SUBHEADER = "To best meet your seating accommodation needs for your disability, please choose any of the following that apply:";
...
//STEP--5,6 & STEP--7
        ...
        //Verifying sub-header
        ValidationUtil.validateTestStep("'To best meet your seating ...' Sub header is displaying under Disability Seating on Reservation summary page",
                pageObjectManager.getReservationSummaryPage().getToBestMeetVerbiage().getText(),DISABILITY_SEATING_SUBHEADER);

        //Select Sub option of Disability Seating
