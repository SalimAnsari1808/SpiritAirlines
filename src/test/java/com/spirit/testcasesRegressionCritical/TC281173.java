...
//**********************************************************************************************
//Test Case ID: TC281173
//Test Name: E2E_Guest_RT DOM 1 ADT 1 Child 2-5_Connecting Flight_Standard_Bundle It [Tier 3] Bags_Trills Seats_No Extras CI Web_Credit Card
...
public class TC281173 extends BaseClass {
    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "RoundTrip" , "DomesticDomestic" , "WithIn7Days" , "Within21Days" , "Adult" , "InfantSeat" ,
                    "Guest" , "Connecting" , "BundleIt" , "DynamicShoppingCartUI" , "CarryOn" , "CheckedBags" , "BagsUI" , "Standard" ,
                    "SeatsUI" , "FlightFlex" , "ShortCutBoarding" , "CheckInOptions" , "OptionalUI" , "Visa"})
    public void E2E_Guest_RT_DOM_1_ADT_1_Child_2_5_Connecting_Flight_Standard_Bundle_It_Bags_Trills_Seats_No_Extras_CI_Web_Credit_Card(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC281173 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
