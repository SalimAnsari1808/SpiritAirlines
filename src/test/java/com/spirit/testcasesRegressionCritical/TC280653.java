...
//Test Case ID: TC280653
//Test Name: 247. E2E_FS_OW DOM 1 ADT 1 child +2_SW Change to 1 ADT 2 children +2 Bundle It [Tier 3] Fare Direct Flight_STD_OW 1CO 1CB_1 Free Seat_No Extras_CI Web_Voucher_Reservation Credit_Credit Card
// Created By: Anthony
//Created On : 19-June-2019
//Reviewed By: Salim Ansari
//Reviewed On: 19-June-2019
//**************************************************************************************************
public class TC280653 extends BaseClass {
    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "Child" , "FreeSpirit" ,
                     "NewFlightSearch" , "NonStop" , "BundleIt" ,"PassengerInformationUI", "CarryOn" , "CheckedBags" ,
                     "BagsUI", "Standard" ,"SeatsUI", "FlightFlex" , "ShortCutBoarding" , "CheckInOptions" , "OptionalUI" ,
                     "Voucher" , "ReservationCredit" , "MasterCard" ,"PaymentUI","ConfirmationUI", "ActiveBug"})
    public void E2E_FS_OW_DOM_1_ADT_1_child_2_SW_Change_to_1_ADT_2_children_Bundle_It_Fare_Direct_Flight_STD_OW_1CO_1CB_1_Free_Seat_No_Extras_CI_Web_Voucher_Reservation_Credit_Credit_Card(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC280653 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
        ...
        //create Reservation credit for booking
        createResCredit();
