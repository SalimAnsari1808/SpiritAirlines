...
public class TC91076 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "WithIn7Days" , "Child" , "Guest" , "BookIt" , "NonStop" , "MandatoryFields" , "PassengerInformationUI"})
    public void Customer_Info_CP_BP_NEG_UMNR_as_a_guest(@Optional("NA") String platform) {

        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91076 under REGRESSION-CRITICAL suite on " + platform + " Browser", true);
        }
