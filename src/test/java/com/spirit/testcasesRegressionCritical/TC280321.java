...
//Test Case ID: TC280321
//Description: Task 24259: 31657 473. E2E_9DFC_OW DOM MAX PAX All UMNR_DirectFlight_VisionImpairedAndServiceAnimal_ThrillBags_Included seats_NoExtras CI web_Reservation Credit, Credit Card
//Created By: Gabriela
...
public class TC280321 extends BaseClass {
    ...
    @Test (groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "WithIn7Days" ,"Child" , "NineDFC" , "NewFlightSearch" , "NonStop" ,
                     ...
                     "ShortCutBoarding" ,"OptionalUI", "ReservationCredit" , "Visa" ,"PaymentUI", "ActiveBug","ConfirmationUI"})
    public void E2E_9DFC_OW_DOM_MAX_PAX_All_UMNR_DirectFlight_VisionImpairedAndServiceAnimal_ThrillBags_Included_seats_NoExtras_CI_web_Reservation_Credit_Credit_Card(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC280321 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
