...
//**********************************************************************************************
//Test Case ID: TC280908
//Test Name: 31685 584. E2E_FSMC_OW DOM Multi ADT_Direct Boost It [Tier 2]_Bags_Free Seat_No Extras Web CI_Reservation Credit + voucher
//Description:
//Created By : Kartik
...
public class TC280908 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"ActiveBug" , "BookPath" , "OneWay" , "DomesticDomestic" , "WithIn21Days" , "Adult" , "FSMasterCard" , "NonStop" ,
                    "BoostIt" ,  "CheckedBags" , "Standard" , "ReservationCredit" , "Voucher" , "DynamicShoppingCartUI","CheckInOptions"})
    public void E2E_FSMC_OW_DOM_Multi_ADT_Direct_Boost_It_Tier_2_Bags_Free_Seat_No_Extras_Web_CI_Reservation_Credit_voucher(@Optional("NA") String platform) {

        //Mention Suite and Browser in reports
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC280908 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
        ...
        WaitUtil.untilPageLoadComplete(getDriver());
        if (!pageObjectManager.getPaymentPage().getTotalDuePriceText().getText().contains("$0.00"))
        {
    ...
    private void createResCredit() {
        ...
        final String BAGS_VALUE         = "Carry_1|Checked_5";
