...
// **********************************************************************************************
// TestCase :   TC91175
// Description: CP_CI_Car Modal_Reserve a car_DOM-INT_Neg
//Created By:   Salim Ansari
//Created On:   07-Aug-2019
//Reviewed By:  Kartik Chauhan
//Reviewed On:  07-Aug-2019
//**********************************************************************************************
public class TC91175 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups={"CarsUI", "CheckIn", "RoundTrip", "DomesticInternational", "WithIn7Days", "Adult", "NonStop","BookIt","NoBags","NoSeats","CheckInOptions", "TravelInsuranceBlock", "MasterCard","ReservationUI","BoardingPassUI"})

    public void CP_CI_Car_Modal_Reserve_a_car_DOM_INT_Neg(@Optional("NA")String platform){
        //mention the browser
        if(!platform.equals("NA")){
            ValidationUtil.validateTestStep("Starting Test Case ID TC91175 under REGRESSION-CRITICAL suite on " + platform +" Browser", true);
        }
        /******************************************************************************
