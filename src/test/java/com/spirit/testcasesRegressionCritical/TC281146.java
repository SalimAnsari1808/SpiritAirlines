...
//**********************************************************************************************
//Test Case ID: TC281146
//Description: E2E_Guest_RT DOM Multi ADT_No Bags_No Seats_No Extras CI Web_Discover
//Created By : Sunny Sok
//Created On : 28-May-19
//Reviewed By: Salim Ansari
//Reviewed On: 29-May-19
//**********************************************************************************************
public class TC281146 extends BaseClass{
    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "RoundTrip" , "DomesticDomestic" , "Outside21Days" , "Adult" , "Guest" , "NonStop" , "BookIt" ,
                    "NoBags" , "NoSeats" , "Discover"})
    public void E2E_Guest_RT_DOM_Multi_ADT_No_Bags_No_Seats_No_Extras_CI_Web_Discover(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC281146 under REGRESSION-CRITICAL Suite on " + platform + " Browser" , true);
        }
