...
//**********************************************************************************************
//Test Case ID: TC91041
//Description: Customer Info_CP_BP _NEG_FS member forgot password email FS Number
...
public class TC91041 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "NonStop" , "WithIn21Days" , "Adult" , "FreeSpirit" , "BookIt" , "PassengerInfoPasswordReset" , "Email" , "RetrievePasswordUI"})

    public void Customer_Info_CP_BP_NEG_FS_member_forgot_password_email_FS_Number(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91041 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
...
//STEP 1: Get to the customer infomation page with a FS member that is already created and data is already stored,click on reset password under log in
        //Home Page Methods
...
//Step 2: input incorrect email for FS member
...
//Step 3: input correct FS email address and click send to get email
...
//Step 4: Validate that the Pop-Up Verbiage is correct
...
//Step 5: Click outside of popup
        //unable to click on an elements that isn't intractable
...
//Step 6: Follow steps on the email
        ...
        System.out.println(memberCredentials.get("fsNumber"));
        System.out.println(memberCredentials.get("email"));
        System.out.println(memberCredentials.get("tempResetPW"));
...
//Step 7: Validate used is logged in
    ...
    private Map<String, String> createNewFSMember() {
        ...
        //firstname
        pageObjectManager.getMemberEnrollmentPage().getUserFirstNameTextBox().sendKeys(firstNameValue);
