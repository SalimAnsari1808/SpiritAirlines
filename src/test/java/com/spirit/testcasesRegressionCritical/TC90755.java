...
public class TC90755 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "Child" , "InfantSeat" , "InfantLap" , "Guest" , "NonStop" , "BookIt" , "PassengerInformationUI"})
    public void Customer_Info_CP_BP_Validate_customer_info(@Optional("NA") String platform) {

        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC90755 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
