...
//**********************************************************************************************
//Test Case ID: TC90834
//Description : Misc_CP_MT_SinglePAX _ Contact info_Verify information is correct
...
public class TC90834 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"MyTrips" , "OneWay" , "DomesticDomestic" , "WithIn21Days" , "Adult" , "Guest" , "Nonstop" , "BookIt" , "NoBags" , "NoSeats" , "TravelInsurancePopUp" , "MasterCard" , "ReservationUI"})
    public void Misc_CP_MT_SinglePAX_Contact_infoContact_info_Verify_information_is_correct(@Optional("NA") String platform) {
    ...
    if(!platform.equals("NA")){
      ValidationUtil.validateTestStep("Starting Test Case ID TC90834 under REGRESSION-CRITICAL suite on " + platform +" Browser", true);
    }
