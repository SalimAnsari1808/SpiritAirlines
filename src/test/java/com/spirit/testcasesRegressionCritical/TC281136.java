...
//**********************************************************************************************
//Test Case ID: TC281136
//Description: 179. E2E_Guest_RT DOM 1 ADT 1 Child 15-18_SW Change Airports, Boost It Fare, Connecting Flight_PAX 1 Vision Disability_Boost It Bags_Any Seats CWO_SB and SS, CI Web_TG_Voucher Reservation credit and CC
//Created By : Anthony Cardona
//Created On : 31-May-2019
//Reviewed By: Salim Ansari
//Reviewed On: 03-June-2019
//**********************************************************************************************
public class TC281136 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath" , "RoundTrip" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "Child" , "Guest" , "NewFlightSearch" ,
                    "Connecting" , "BoostIt" , "PassengerInfoSSR" , "CarryOn" , "DynamicShoppingCartUI" , "Standard" ,
                    "ShortCutSecurity" , "ShortCutBoarding" , "MasterCard" , "Voucher" , "ReservationCredit" ,  "TravelInsuranceBlock",
                    "OptionalUI"})
    public void E2E_Guest_RT_DOM_1_ADT_1_Child_15to18_SW_Change_Airports_Boost_It_Fare_Connecting_Flight_PAX_1_Vision_Disability_Boost_It_Bags_Any_Seats_CWO_SB_and_SS_CI_Web_TG_Voucher_Reservation_credit_and_CC(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC281136 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
        ...
        final String NEW_ARR_AIRPORT_CODE   = "BWI";
        final String NEW_ADULT              = "1";
        ...
        final String ADDITIONAL_SSR         = "VisionDisability";
        ...
        pageMethodManager.getHomePageMethods().selectTravellingPassenger(NEW_ADULT, NEW_CHILD, INFANT_SEAT, INFANT_LAP);
        pageMethodManager.getHomePageMethods().clickSearchButton();
        ...
        ValidationUtil.validateTestStep("Validating Bags Total Price displayed is 0.00 on Bags Page for Boost It",
