...
//**********************************************************************************************
//Test Case ID: TC90901
//Description: CP_CI_Online Check In page full validation_Add Vision Disability
//Created By: Kartik chauhan
//Created On: 18-July-2019
//Reviewed By: Salim Ansari
//Reviewed On: 19-July-2019
//**********************************************************************************************
public class TC90901 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"CheckIn" , "RoundTrip" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "Guest" , "Connecting" , "BookIt" , "AddEditSSR" , "NoBags" , "NoSeats" , "CheckInOptions" , "MasterCard" , "TravelInsurancePopUp" , "ReservationUI"})
    public void CP_CI_Online_Check_In_page_full_validation_Add_Vision_Disability(@Optional("NA") String platform) {
        /******************************************************************************
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC90901 under REGRESSION-CRITICAL Suite on " + platform + " Browser"   , true);
        }
        ...
        final String SSR_VALUE          = "VisionDisability";
