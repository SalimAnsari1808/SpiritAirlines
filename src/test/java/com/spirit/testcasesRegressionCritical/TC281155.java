...
//**********************************************************************************************
//Test Case ID: TC281155
//Description:  113. E2E_Guest_MC DOM 1 ADT 1 Child +15 -18_ Connecting Flight_Standard_No Bags_No Seats_SS, SB, FF, CI Web_Mastercard
...
public class TC281155 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"BookPath" , "MultiCity" , "DomesticDomestic" , "WithIn7Days" , "Adult" ,"Child", "Guest" , "Connecting" , "BookIt" , "NoBags" , "NoSeats" , "FlightFlex" , "ShortCutSecurity" ,"ShortCutBoarding", "CheckInOptions" , "MasterCard"})
    public void E2E_Guest_MC_DOM_1_ADT_1_Child_15_18_Connecting_Flight_Standard_No_Bags_No_Seats_SS_SB_FF_CI_Web_Mastercard(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC281155 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
        ...
        //select child of 16 years
        pageObjectManager.getHomePage().getChildTravelerPanel().get(0).findElement(By.tagName("input")).sendKeys(TestUtil.getStringDateFormat((-5840), "MM/dd/yyyy"));
        ...
        TestUtil.clearTextBoxUsingSendKeys(getDriver(),pageObjectManager.getPassengerInfoPage().getAdultDOBListTextBox().get(1));
        pageObjectManager.getPassengerInfoPage().getAdultDOBListTextBox().get(1).sendKeys(TestUtil.getStringDateFormat((-5840), "MM/dd/yyyy"));
