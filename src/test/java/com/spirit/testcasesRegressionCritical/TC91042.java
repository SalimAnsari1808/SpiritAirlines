...
//**********************************************************************************************
//Test Case ID: TC91042
//Description: Customer Info_CP_BP _FS member forgot password email
...
public class TC91042 extends BaseClass {
    ...
    public void Customer_Info_CP_BP_FS_member_forgot_password_email(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91042 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
...
//Step 4: input correct FS email address and click send to get email
