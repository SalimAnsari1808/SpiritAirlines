...
//**********************************************************************************************
//Test Case ID: TC91043
//Description: Customer Info_CP_BP _FS member forgot password FS number
...
public class TC91043 extends BaseClass {
    ...
    public void Customer_Info_CP_BP_FS_member_forgot_password_FS_number(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91043 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
...
//STEP 1: Get to the customer infomation page with a FS member that is already created and data is already stored
        //Home Page Methods
...
//Step 5: Validate that the Pop-Up Verbiage is correct
...
//Step 6: Click outside of the pop-up
        //Selenium not capable of clicking on element that cannot be intractable
...
//Step 8 and 9: Find email and get temporary password
