...
//**********************************************************************************************
//Test Case ID: TC91095
//Description : CP_CI_Ancillaries_Modify Seats After Check-In
...
public class TC91095 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"CheckIn" , "OneWay" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "Guest" , "NonStop" , "BookIt" , "NoBags" , "BigFrontSeat" , "CheckInOptions" , "MasterCard" , "SeatsUI" , "AddEditSeats","BoardingPassUI"})
    public void CP_CI_Ancillaries_Modify_Seats_After_Check_In(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91095 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
...
//Step 8: Click to print boarding pass
        ...
        //IF Big Front seat number is A or D, boarding pass will show " Window "
        //IF Big Front seat number is B or C, boarding pass will show " Aisle "
        if(seatNumber.contains("A") || seatNumber.contains("D")) {
            seatNumber = seatNumber + " Window ";
        }

        else if(seatNumber.contains("B") || seatNumber.contains("C")) {
            seatNumber = seatNumber + " Aisle ";
        }

        ValidationUtil.validateTestStep("The New seat number is displayed correctly" , seatNumber,
                pageObjectManager.getBoardingPassPage().getSeatNumberText().get(0).getText());
    }
}