...
//**********************************************************************************************
//Test Case ID: TC90904
//Description: CP_CI_Online Check In page full validation_Add Hearing and Vision Disability
//Created By:  Kartik chauhan
//Created On:  22-July-2019
//Reviewed By: Salim Ansari
//Reviewed On: 22-July-2019
//**********************************************************************************************
public class TC90904 extends BaseClass {
    ...
    public void CP_CI_Online_Check_In_page_full_validation_Add_Hearing_and_Vision_Disability(@Optional("NA") String platform) {
        //**************************Navigate to Reservation Page**********************/
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC90904 under REGRESSION-CRITICAL Suite on " + platform + " Browser"   , true);
        }
        ...
        final String SSR_VALUE              = "HearingImpaired|VisionDisability";
