...
public class TC90941 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "FreeSpirit" , "NonStop" , "BookIt" ,"PassengerInfoSignIn" ,"MandatoryFields", "PassengerInformationUI"})
    public void Customer_Info_CP_BP_NEG_Have_two_PAX_with_the_same_name_while_logged_in_as_a_FS_member(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC90941 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
