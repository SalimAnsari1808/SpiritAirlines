...
//**********************************************************************************************
//Test Case ID: TC91470
//Description : CP_MT_Payment Page_FS_use fraudulent CC
...
public class TC91470 extends BaseClass{

    @Parameters({"platform"})
    @Test(groups = {"MyTrips" , "OneWay" , "DomesticDomestic" , "Outside21Days" , "Adult" , "FreeSpirit" , "NonStop" , "BookIt" , "PassengerInfoSSR" , "CarryOn" , "CheckedBags" , "Standard" ,"ShortCutBoarding","CheckInOptions", "MasterCard" , "PaymentUI","TravelInsurancePopUp","AddEditBags"})
    public void CP_MT_Payment_Page_FS_use_fraudulent_CC(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91470 under REGRESSION-CRITICAL Suite on " + platform + " Browser" , true);
        }
