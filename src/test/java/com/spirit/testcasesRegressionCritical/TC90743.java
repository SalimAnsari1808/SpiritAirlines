...
// **********************************************************************************************
// TestCase ID: TC90743
// TestCase : Bags_CP_BP_DOM_1PAX_Validate Bicycle info
// Created By : Kartik Chauhan
// Created On : 24-Jun-2019
// Reviewed By: Salim Ansari
// Reviewed On: 25-Jun-2019
// **********************************************************************************************
public class TC90743 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "Guest" , "NonStop" , "BookIt" , "Bikes" , "BagsUI"})
    public void Bags_CP_BP_DOM_1PAX_Validate_Bicycle_info(@Optional("NA") String platform) {
        /******************************************************************************
         ****************************Navigate to Bags Page via FA user*****************
         ******************************************************************************/
        //Mention Suite and Browser in reports
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC90743 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
        ...
        final String MORE_INFO_LINK_URL = "https://customersupport.spirit.com/hc/en-us/articles/202096596-Can-I-bring-my-bicycle-on-my-trip";
...
//STEP--4
        ...
        pageObjectManager.getBagsPage().getDepartingBicycleInfoIconLink().get(0).click();
//STEP--5
        ...
        ValidationUtil.validateTestStep("Verify User navigated to Bycycle Information Page",
