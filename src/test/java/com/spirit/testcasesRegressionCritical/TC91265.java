...
//**********************************************************************************************
//Test Case ID: TC91265
//Description: Task 24744: 35130 CP_Header_Ayuda
//Created By: Gabriela
...
public class TC91265 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups={"HomeUI", "Spanish", "Header"})

    public void CP_Header_Ayuda(@Optional("NA") String platform) {

        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91265 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
        ...
        final String HELP_URL               = "https://customersupport.spirit.com/hc/es";
