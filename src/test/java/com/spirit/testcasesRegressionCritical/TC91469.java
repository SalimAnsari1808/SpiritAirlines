...
//**********************************************************************************************
//Test Case ID: TC91469
//Description : CP_MT_Payment Page_Guest_use fraudulent CC
//Created By : Sunny Sok
//Created On : 08-JUL-2019
//Reviewed By: Salim Ansari
//Reviewed On: 18-JUL-2019
//**********************************************************************************************
public class TC91469 extends BaseClass{

    @Parameters({"platform"})
    @Test(groups = {"MyTrips" , "OneWay" , "DomesticDomestic" , "Outside21Days" , "Adult" , "Guest" , "NonStop" , "BookIt" , "PassengerInfoSSR" , "CarryOn" , "CheckedBags" , "Standard" ,"ShortCutBoarding","CheckInOptions", "MasterCard" ,"TravelInsurancePopUp", "PaymentUI","AddEditBags"})
    public void CP_MT_Payment_Page_Guest_use_fraudulent_CC(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91469 under REGRESSION-CRITICAL Suite on " + platform + " Browser" , true);
        }
