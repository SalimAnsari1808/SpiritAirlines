...
//**********************************************************************************************
//Test CaseID: TC281178
//Title      : 150. E2E_Guest_RT DOM MAX PAX MIX_Direct Flight_Standard_Bundle It [Tier 3] Bags_Trills Seats_No Extras CI Web_Credit Card
...
public class TC281178 extends BaseClass {
    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "RoundTrip" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "Child" , "InfantSeat" , "InfantLap" ,
                    "Guest" , "NonStop" , "BundleIt" , "DynamicShoppingCartUI" , "CarryOn" , "CheckedBags" , "Standard" , "FlightFlex" ,
                    "ShortCutBoarding" , "OptionalUI" , "Visa"})
    public void E2E_Guest_RT_DOM_MAX_PAX_MIX_Direct_Flight_Standard_Bundle_It_Tier_3_Bags_Trills_Seats_No_Extras_CI_Web_Credit_Card (@Optional("NA") String platform) {
        /******************************************************************************
         ***************************Navigate to Confirmation Page**********************
         ******************************************************************************/
        //Mention Suite and Browser in reports
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC281178 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
