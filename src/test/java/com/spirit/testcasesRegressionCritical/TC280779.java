...
public class TC280779 extends BaseClass {
    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "RoundTrip" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "Child" , "FreeSpirit" , "NewFlightSearch" ,
                     "NonStop" , "BundleIt" , "DynamicShoppingCartUI" , "CarryOn" , "CheckedBags" , "Standard" ,"FlightFlex",
    ...
    public void E2E_FS_RT_DOM_1_ADT_1child_5_SW_Change_Airports_Bundle_Fare_Direct_Flight_STD_RT_1CO_1CB_Any_Seats_No_Extras_CI_Web_Credit_Card (@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC280779 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
