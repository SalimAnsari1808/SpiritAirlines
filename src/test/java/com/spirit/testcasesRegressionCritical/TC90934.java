...
public class TC90934 extends BaseClass {
  //**********************************************************************************************
//Test Case ID: TC90934
//Description: $9FC Booking_CP_BP_Passenger_ Dynamic Shopping Cart  test Wireframe of 9DFC sign up
...
//**********************************************************************************************
  @Parameters({"platform"})
  @Test(groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "NineDFC" ,"Connecting", "BookIt" ,"DynamicShoppingCartUI", "CarryOn" ,"CheckedBags" , "NoSeats" ,"ShortCutBoarding","CheckInOptions", "MasterCard" ,"AccountProfileUI"})

  public void $9FC_Booking_CP_BP_Passenger_Dynamic_Shopping_Cart_test_Wireframe_of_9DFC_sign_up(@Optional("NA") String platform) {
    if (!platform.equals("NA")) {
      ValidationUtil.validateTestStep("Starting Test Case ID TC90934 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
    }
...
//    Step 2
    ValidationUtil.validateTestStep("Verify 9DFC member drop down link is visible on Dynamic Shopping Cart",
    ...
    ValidationUtil.validateTestStep("Verify 9DFC Terms and Condition are visible on Dynamic Shopping Cart",
...
//    Step 8-9
  ...
  private void joinNineFCFromShoppingCart(){
    ...
    ValidationUtil.validateTestStep("User verify 9FC label is displayed in Shopping Cart",
            pageObjectManager.getHeader().getMembershipVerbiageText().getText(), $9FC_LABEL);

    //verify 9DFC membership Price in Cart
    ValidationUtil.validateTestStep("User verify 9FC Price is displayed in Shopping Cart",
            pageObjectManager.getHeader().getMembershipAmountText().getText(), $9FC_PRICE);
  }
}
