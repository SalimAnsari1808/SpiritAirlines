...
//**********************************************************************************************
//Test CaseID: TC280791
//Title      : 311. E2E_FS_RT DOM 1 ADT 1 INFT (lap)_Thru Flight_STD_RT 1CO 0CB_Any Seats_No Extras_CI Web_Reservation Credit_Credit Card
...
public class TC280791 extends BaseClass {
    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "RoundTrip" , "DomesticDomestic" , "Outside21Days" , "Adult" , "InfantLap" ,
                     "FreeSpirit", "NonStop" , "BundleIt" , "DynamicShoppingCartUI" , "CarryOn" , "CheckedBags" ,
                     "BagsUI" , "Standard" , "FlightFlex" , "ShortCutBoarding" , "OptionalUI" , "ReservationCredit" ,
                     "Visa","SeatsUI","ConfirmationUI"})

    public void E2E_FS_RT_DOM_1_ADT_1_INFT_lap_Thru_Flight_STD_RT_1CO_0CB_Any_Seats_No_Extras_CI_Web_Reservation_Credit_Credit_Card(@Optional("NA") String platform) {
        /******************************************************************************
         ***************************Navigate to Confirmation Page**********************
         ******************************************************************************/
        //Mention Suite and Browser in reports
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC280791 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
...
//        //select a child with age between 2-3 years
...
//        travellingChildSection.findElement(By.tagName("input")).sendKeys(TestUtil.getStringDateFormat((-896), "MM/dd/yyyy"));
//
...
//        pageObjectManager.getHomePage().getChildPopUpCloseButton().click();
        ...
        for(int i = 0; i < pageObjectManager.getBagsPage().getDepartingCarryOnBagCounterTextBox().size(); i ++) {
            ...
            ValidationUtil.validateTestStep("Verifying Carry On is preselected",
                    JSExecuteUtil.getElementTextValue(getDriver(),
                            pageObjectManager.getBagsPage().getDepartingCarryOnBagCounterTextBox().get(i)),BAGS_PRESELECTED);
