...
//**********************************************************************************************
public class TC91066 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"BookPath" , "RoundTrip" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "Guest" , "NonStop" , "BookIt" ,"ContactInformation", "PassengerInformationUI"})
    public void Customer_Info_CP_BP_Validate_Foreign_Address_in_contact_information(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91066 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
