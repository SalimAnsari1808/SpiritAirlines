...
//**********************************************************************************************
//Test Case ID: TC91194
//Title       : 35398 Check In_CP_CI_Timatic_Passport Pop-up_Multi
//Created By  : Kartik chauhan
//Created On  : 26-Jun-2019
//Reviewed By : Salim Ansari
//Reviewed On : 26-Jun-2019
//**********************************************************************************************
public class TC91194 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"CheckIn", "OneWay", "DomesticInternational", "WithIn7Days", "Adult", "Guest", "Nonstop", "BookIt", "NoBags", "NoSeats", "CheckInOptions", "MasterCard", "ReservationUI" , "AddEditPassportInfo" , "PassportUI"})
    public void Check_In_CP_CI_Timatic_Passport_Popup_Multi(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")){
            ValidationUtil.validateTestStep("Starting Test Case ID TC91194 under REGRESSION-CRITICAL suite on " + platform +" Browser", true);
        }
...
//*****************Enter details for second pax********
        //enter valid passport
        pageObjectManager.getPassportPage().getPassengerPassportNumberTextBox().get(1).sendKeys("ABCKJDI2");

        //put wait for 2 sec
        WaitUtil.untilTimeCompleted(2000);

        //Set Greater then Today's Expiration Date
        String strDepDate1 = "100";
        String strActualDepDate1;

        //Convert the format of Expiration date
        strActualDepDate1 = TestUtil.getStringDateFormat(strDepDate1, "MM/dd/yyyy");

        //click on Passport Expiration Date Text Box
        pageObjectManager.getPassportPage().getPassengerExpirationDateTextBox().get(1).click();

        //Send specific date to Expiration date Text box
        pageObjectManager.getPassportPage().getPassengerExpirationDateTextBox().get(1).sendKeys(strActualDepDate1);
//STEP--2
