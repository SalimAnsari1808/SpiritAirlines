...
//**********************************************************************************************
//Test CaseID: TC281180
//Title      : 31570 152. E2E_Guest_RT DOM 1 ADT_SW Change Date Connecting Flight_Standard_No Bags_BFS Seats_No Extras CI Web_Credit Card
//Created By : Kartik
...
public class TC281180 extends BaseClass {
    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "RoundTrip" , "DomesticDomestic" , "WithIn21Days" , "Adult" , "Guest" , "NewFlightSearch" ,
                     "Connecting" , "BookIt" , "NoBags" , "BigFrontSeat" , "DynamicShoppingCartUI" , "CheckInOptions" , "Visa"})
    public void E2E_Guest_RT_DOM_1_ADT_SW_Change_Date_Connecting_Flight_Standard_No_Bags_BFS_Seats_No_Extras_CI_Web_Credit_Card(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC281180 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
