...
public class TC90739 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "FreeSpirit" , "NonStop" , "BookIt" , "PassengerInfoSSR" , "CarryOn" , "CheckedBags" , "Standard" , "SeatsUI" ,"ShortCutBoarding","CheckInOptions", "PaymentUI"})
    public void CP_BP_Payment_Page_Passenger_Info(@Optional("NA") String platform) {

        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC90739 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
