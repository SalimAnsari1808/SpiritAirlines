...
//**********************************************************************************************
//Test Case ID: TC369579
//Test Name:    Inhibited Document_CP_CI_INT_ One way international triggers inhibited document
...
public class TC369579 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"CheckIn" , "OneWay" , "DomesticInternational" , "WithIn7Days" , "Adult" , "NonStop" , "Guest" , "BookIt" , "NoBags" , "NoSeats" , "CheckInOptions" , "MasterCard" , "BoardingPassUI"})
    public void Inhibited_Document_CP_CI_INT_One_way_international_triggers_inhibited_document(@Optional("NA") String platform) {
        /******************************************************************************
         **********************Navigate to Boarding Pass Page**************************
         ******************************************************************************/
        //Mention Suite and Browser in reports
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC369579 under REGGRESSIONAL-CRITICAL Suite on " + platform + " Browser", true);
        }
        ...
        final String INHIBITED_HEADER        = "BUMMER… YOU NEED TO SEE AN AGENT.";
        final String INHIBITED_CONTEXT_LINE1 = "Unfortunately, the magic of the internet won't let us scan your passport - please visit an agent.";
        final String INHIBITED_CONTEXT_LINE2 = "Keep proper documentation and a valid passport with you at all times during travel";
        final String INHIBITED_CONTEXT_LINE3 = "Please know specific country entry requirements for travel";
        final String INHIBITED_CONTEXT_LINE4 = "You’ll need to view important international travel restrictions at spirit.com/international";
        ...
        String BoardingExpectedTime = getDesiredTime(DepartureTime , 0 , -60, "h:m");
        ...
        //Validate inhibited Context is displayed
        ValidationUtil.validateTestStep("Validate inhibited Context is displayed",
                pageObjectManager.getBoardingPassPage().getInhibitedDocBullet3Text().get(0).getText(), INHIBITED_CONTEXT_LINE4);
        ...
        ValidationUtil.validateTestStep("Validate Duration label and time is displayed",TestUtil.verifyElementDisplayed(pageObjectManager.getBoardingPassPage().getInhibitedDocFlightDurationLabel().get(0))
                && pageObjectManager.getBoardingPassPage().getInhibitedDocFlightDurationText().get(0).getText().replaceAll(" ","").equals(DurationTime));
    }
