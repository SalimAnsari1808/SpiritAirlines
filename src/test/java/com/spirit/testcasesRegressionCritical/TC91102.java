...
//**********************************************************************************************
//Test Case ID: TC91102
//Description: CP_CI_Online Check In page full validation_Add Emotional Support Animal
//Created By:   Kartik chauhan
//Created On:   18-July-2019
//Reviewed By: Salim Ansari
//Reviewed On: 19-July2019
//**********************************************************************************************
//TODO: Bug [IN:24734] CP: MT/CI: When adding Special services or wheel chair SSR's on the reservation summary page the ssr are not being added to the pnr
//https://spirit.spiraservice.net/37/Incident/24734.aspx
/**10/21/19 test case passed, removed active bug tag**/


public class TC91102 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"CheckIn","RoundTrip","DomesticDomestic","WithIn7Days","Adult","Guest","Connecting","BookIt",
                    "PassengerInfoSSR","NoBags","NoSeats","CheckInOptions","MasterCard","TravelInsurancePopUp",
                    "ReservationUI","BoardingPassUI"})
    public void CP_CI_Online_Check_In_page_full_validation_Add_Emotional_Support_Animal(@Optional("NA") String platform) {
        //***************************Navigate to Reservation Page**************************************/

        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91102 under REGRESSION-CRITICAL Suite on " + platform + " Browser"   , true);
        }
...
//STEP--5,6 & STEP--7
        //Add & verify SSR on Reservation page
