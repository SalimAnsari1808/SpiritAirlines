...
public class TC90935 extends BaseClass {
  //**********************************************************************************************
//Test Case ID: TC90935
//Description: $9FC Booking_CP_BP_Bags_ Dynamic Shopping Cart  test Wireframe of 9DFC sign up
...
//**********************************************************************************************
  @Parameters({"platform"})
  @Test(groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "NineDFC" , "Connecting","BookIt" , "CarryOn" ,"CheckedBags" , "NoSeats" , "ShortCutBoarding" ,"CheckInOptions", "MasterCard" , "DynamicShoppingCartUI","AccountProfileUI"})

  public void $9FC_Booking_CP_BP_Bags_Dynamic_Shopping_Cart_test_Wireframe_of_9DFC_sign_up(@Optional("NA") String platform) {
    if (!platform.equals("NA")) {
      ValidationUtil.validateTestStep("Starting Test Case ID TC90935 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
    }
