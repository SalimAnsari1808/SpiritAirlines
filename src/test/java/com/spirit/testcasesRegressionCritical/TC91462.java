...
//**********************************************************************************************
//Test Case ID: TC91462
//Description : CP_CI_Payment Page_Guest_use fraudulent CC
...
public class TC91462 extends BaseClass{

    @Parameters({"platform"})
    @Test(groups = {"CheckIn" , "OneWay" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "Guest" , "NonStop" , "BookIt" , "PassengerInfoSSR" , "CarryOn" , "CheckedBags" , "Standard","ShortCutBoarding", "CheckInOptions" , "TravelInsurancePopUp" , "MasterCard" , "PaymentUI","AddEditBags"})
    public void CP_CI_Payment_Page_Guest_use_fraudulent_CC(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91462 under REGRESSION-CRITICAL Suite on " + platform + " Browser" , true);
        }
        ...
        ValidationUtil.validateTestStep("Validating right Duration information is displayed ",
        ...
        //verify passenger first and last name
