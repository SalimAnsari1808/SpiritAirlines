...
public class TC90918 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath" , "RoundTrip" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "Guest" , "NonStop" , "BundleIt" , "CarryOn" , "CheckedBags" , "Standard" , "SeatsUI"})
    public void Seats_Page_CP_BP_CI_MT_Generic_Wireframe_Validation_Thrills_Combo(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC90918 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
