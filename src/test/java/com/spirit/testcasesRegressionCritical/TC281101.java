...
//**********************************************************************************************
//Test Case ID: TC281101
//Description:  E2E_Guest_RT DOM 1 ADT 1 Child 15-18_SW Change Airports, Bundle It, Connecting Flight_PAX 1 Vision Disability_No Bags_Any Seats CWO_No Extras, CI Web_Credit Card
//Created By : Sunny Sok
//Created On : 29-May-2019
//Reviewed By: Salim Ansari
//Reviewed On: 04-Jun-2019
//**********************************************************************************************
public class TC281101 extends BaseClass {
    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "OneWay" , "WithIn7Days" , "DomesticDomestic" , "Adult" , "Child" , "Guest" , "NonStop" ,
                     "NewFlightSearch" , "BundleIt" , "PassengerInfoSSR" , "DynamicShoppingCartUI" , "CarryOn" , "CheckedBags" ,
                     "BagsUI" , "Standard" , "FlightFlex" , "ShortCutBoarding" , "MasterCard", "CheckInOptions","OptionalUI","PaymentUI",
                     "SeatsUI","ConfirmationUI"})
    public void E2E_Guest_RT_DOM_1_ADT_1_Child_15TO18_SW_Change_Airports_Bundle_It_Connecting_Flight_PAX_1_Vision_Disability_No_Bags_Any_Seats_CWO_No_Extras_CI_Web_Credit_Card(@Optional("NA") String platform) {
        /******************************************************************************
         ***************************Navigate to Confirmation Page**********************
         ******************************************************************************/
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC281101 under REGRESSION-CRITICAL Suite on " + platform + " Browser"   , true);
        }
