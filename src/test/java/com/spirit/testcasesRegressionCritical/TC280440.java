...
public class TC280440 extends BaseClass {
    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "InfantSeat" ,"InfantLap", "NineDFC" ,
    ...
    public void E2E_9DFC_OW_DOM_1_ADT_2_INF_1_LAP_1_SEAT_Bundle_Direct_STD_1_CO_Any_Free_NoExt_CI_Web_Credit_Card(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC280440 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
         ...
         ****************************************************************************/
//        ValidationUtil.validateTestStep("Validating there is not check in option when infant on the booking",
