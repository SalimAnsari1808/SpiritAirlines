...
//**********************************************************************************************
//Test Case ID: TC90907
//Description: CP_CI_Online Check In page full validation_UMNR with Service Animal
//Created By:  Kartik chauhan
//Created On:  22-July-2019
//Reviewed By: Salim Ansari
//Reviewed On: 30-July-2019
//**********************************************************************************************
public class TC90907 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"CheckIn" , "RoundTrip" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "Guest" , "Connecting" , "BookIt" , "AddEditSSR" , "NoBags" , "NoSeats" , "CheckInOptions" , "MasterCard" , "TravelInsurancePopUp" , "ReservationUI","HazmatUI","PassportUI"})
    public void CP_CI_Online_Check_In_page_full_validation_UMNR_with_Service_Animal(@Optional("NA") String platform) {
        //***************************Navigate to Payment Page****************************/
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC90907 under REGRESSION-CRITICAL Suite on " + platform + " Browser"   , true);
        }
        ...
        final String SSR_VALUE                  = "ServiceAnimal";
...
//STEP--3
        ...
        ValidationUtil.validateTestStep("Verify Sub Header-'Hey There! online...' of the Confirmation Page",
                TestUtil.verifyElementDisplayed(pageObjectManager.getConfirmationPage().getConfirmationPageSubHeaderText()));

        ValidationUtil.validateTestStep("Verify Sub Header-'Buy Your Bags and Seat...' of the Confirmation Page",
                TestUtil.verifyElementDisplayed(pageObjectManager.getConfirmationPage().getConfirmationPageSubHeaderBuyYourBagsText()));
