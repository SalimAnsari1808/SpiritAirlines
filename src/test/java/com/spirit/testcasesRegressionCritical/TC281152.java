...
public class TC281152 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"BookPath" , "MultiCity" , "DomesticDomestic" , "WithIn7Days" ,"WithIn21Days", "Adult" ,"InfantLap", "Military" , "NonStop" , "BookIt" , "BagsUI" , "CarryOn" , "CheckedBags" , "NoSeats" ,"ShortCutBoarding" , "Visa","PaymentUI"})
    public void E2E_Guest_MC_DOM_1_ADT_1_INFT_LAP_Direct_Fligt_Military_Military_Bags_No_Seats_No_Extras_CI_Web_Visa(@Optional("NA") String platform) {
        ...
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC281152 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
