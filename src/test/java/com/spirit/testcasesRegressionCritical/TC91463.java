...
//**********************************************************************************************
//Test Case ID: TC91463
//Description : CP_CI_Payment Page_FS_use fraudulent CC
...
public class TC91463 extends BaseClass{

    @Parameters({"platform"})
    @Test(groups = { "CheckIn" , "OneWay" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "FreeSpirit" , "NonStop" , "BookIt" , "PassengerInfoSSR" , "CarryOn" , "CheckedBags" , "Standard" ,"ShortCutBoarding", "CheckInOptions" , "TravelInsurancePopUp" , "MasterCard" , "PaymentUI","AddEditBags"})
    public void CP_CI_Payment_Page_FS_use_fraudulent_CC(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91463 under REGRESSION-CRITICAL Suite on " + platform + " Browser" , true);
        }
