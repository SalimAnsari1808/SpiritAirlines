...
public class TC90726 extends BaseClass{

    @Parameters({"platform"})
    @Test(groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "Outside21Days" , "Adult" , "Guest" ,"NonStop", "BoostIt" ,"CheckedBags","BagsUI","Standard","SeatsUI", "DynamicShoppingCartUI","ShortCutBoarding","OptionalUI"})
    public void Dynamic_Shopping_Cart_Options_page_WireFrame(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC90726 under REGRESSION-CRITICAL Suite on " + platform + " Browser" , true);
        }
