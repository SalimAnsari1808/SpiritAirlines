...
//Test Case ID: TC280552
//Test Name: 31667 503. E2E_9DFC_RT DOM 1 ADT 1 Child +5 -15_ConnectingFlight_Standard_BundelBags_BundelSeats_NoExtras CI web_Voucher, ReservationCredit,Visa
//Description:
//Created By : Kartik
...
public class TC280552 extends BaseClass {

    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "RoundTrip" , "DomesticDomestic" , "Within21Days" , "Adult" , "Child" , "NineDFC" , "Connecting" ,
                     "BundleIt" ,"PassengerInformationUI", "CarryOn" , "CheckedBags" ,"BagsUI", "Standard" ,"SeatsUI", "FlightFlex" ,
                     "ShortCutBoarding" , "CheckInOptions" ,"OptionalUI", "Voucher" , "ReservationCredit" , "Visa" ,"PaymentUI",
                     "ActiveBug","ConfirmationUI"})
    public void E2E_9DFC_RT_DOM_1_ADT_1_Child_5_15_ConnectingFlight_Standard_BundelBags_BundelSeats_NoExtras_CI_web_Voucher_ReservationCredit_Visa(@Optional("NA") String platform) {

        //Mention Suite and Browser in reports
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC280552 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
