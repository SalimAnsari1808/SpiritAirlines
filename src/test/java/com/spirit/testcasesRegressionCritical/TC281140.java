...
//**********************************************************************************************
//Test Case ID: TC281140
//Description: 31588 182. E2E_Guest_RT DOM 1 ADT 2 Children 2+_SW Change PAX 1 ADT 2 INF (Lap and Seat), Bundle It [Tier 3] Fare, Connecting Flight_Jr-Sr_Bundle It [Tier 3] Bags_Bundle It [Tier 3] Seats_No Extras, CI Web_Visa
...
public class TC281140 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"BookPath" , "RoundTrip" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "InfantSeat" , "InfantLap" , "Guest" ,
                    "NewFlightSearch" , "Nonstop" , "BundleIt" , "MandatoryFields" , "CarryOn" , "CheckedBags" ,
                    "DynamicShoppingCartUI" , "Standard" , "Visa" , "TravelInsuranceBlock" , "OptionalUI" })
    public void E2E_Guest_RT_DOM_1_ADT_2_Children_2_SW_Change_PAX_1_ADT_2_INF_Lap_and_Seat_Bundle_It_Tier_3_Fare_Connecting_Flight_Jr_Sr_Bundle_It_Tier_3_Bags_Bundle_It_Tier_3_Seats_No_Extras_CI_Web_Visa(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC281140 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
        ...
        final String DEP_BAGS           = "Carry_1|Checked_1|Checked_2|Checked_3|Checked_4|Checked_5||Carry_1|Checked_1|Checked_2|Checked_3|Checked_4|Checked_5";
        final String RET_BAGS           = "Carry_1|Checked_1|Checked_2|Checked_3|Checked_4|Checked_5||Carry_1|Checked_1|Checked_2|Checked_3|Checked_4|Checked_5";
        ...
        pageMethodManager.getBagsPageMethods().selectDepartingBags(RET_BAGS);
