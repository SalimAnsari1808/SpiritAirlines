...
//**********************************************************************************************
//Test Case ID: TC91208
//Test Case Name: Task 24786: 35265 Customer Info_CP_BP_As a FS member Car Booking insufficient age flight
//Created By: Gabriela
...
public class TC91208 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups = {"BookPath" , "RoundTrip" , "FlightCar" , "DomesticDomestic" , "Outside21Days" , "Child" , "FreeSpirit" , "BookIt" , "PassengerInfoSignIn" , "PassengerUI"})
    public void Customer_Info_CP_BP_As_a_FS_member_Car_Booking_insufficient_age_flight(@Optional("NA") String platform) {

        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91208 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }

        //Home Page Constant Values
        final String LANGUAGE               = "English";
        final String JOURNEY_TYPE           = "Vacation";
        final String LOGIN_TYPE             = "FSUMNR";
