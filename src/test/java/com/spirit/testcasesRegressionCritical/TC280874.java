...
//**********************************************************************************************
//Test Case ID: TC280874
//Description: Task 24309: 31695 619. E2E_FSMC_OW DOM 1 ADT 1 Child_SW Change PAX 1 ADT 2 Children, Bundle It [Tier 3], Direct_Standard_Bundle It [Tier 3] Bags_Trills Seats_No Extras CI Web_MultiPay
// Created By: Gabriela
...
public class TC280874 extends BaseClass {

    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "OneWay" , "DomesticDomestic" , "WithIn7Days" , "Adult" , "Child" , "FSMasterCard" ,
                     "NewFlightSearch" , "NonStop" , "BundleIt" , "CarryOn" , "CheckedBags" , "Standard" , "FlightFlex" ,
                     "ShortCutBoarding" , "CheckInOptions" , "MasterCard" , "Voucher" , "ReservationCredit","PaymentUI","ConfirmationUI"})
    public void E2E_FSMC_OW_DOM_1_ADT_1_Child_SW_Change_PAX_1_ADT_2_Children_Bundle_It_Tier_3_Direct_Standard_Bundle_It_Tier_3_Bags_Trills_Seats_No_Extras_CI_Web_MultiPay(@Optional("NA") String platform) {
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC280874 under REGRESSION-CRITICAL Suite on " + platform + " Browser", true);
        }
