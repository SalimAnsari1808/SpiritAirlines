...
//**********************************************************************************************
//Test Case ID: TC91039
//Test Name: Customer Info_CP_BP _NEG_FS member forgot password FS number
//Created By : Kartik Chauhan
//Created On : 30-July-2019
//Reviewed By: Salim Ansari
//Reviewed On: 30-July-2019
//**********************************************************************************************
public class TC91039 extends BaseClass {
    @Parameters({"platform"})
    ...
    public void Customer_Info_CP_BP__NEG_FS_member_forgot_password_FS_number(@Optional("NA") String platform) {
        /******************************************************************************
         ************************Navigate to Retrieve Password Page********************
         ******************************************************************************/
        //Mention Suite and Browser in reports
        if (!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91039 under REGRESSION_CRITICAL Suite on " + platform + " Browser", true);
        }
...
//STEP 1:
        ...
        ValidationUtil.validateTestStep("Verify user is looged out of the application",
