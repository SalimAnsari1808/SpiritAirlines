...
public class TC91230 extends BaseClass {

    @Parameters({"platform"})
    @Test(groups={"HomeUI", "NineDFC"})
    public void  CP_Header_Sign_In_Login_$9FC_number(@Optional("NA") String platform) {
        ...
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC91230 under REGRESSION-CRITICAL Suite on " + platform + " Browser"   , true);
        }
