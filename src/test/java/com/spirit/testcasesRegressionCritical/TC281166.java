...
//**********************************************************************************************
//Test Case ID: TC281166
//Description: E2E_Guest_RT DOM 0 ADT 1 UMNR_Thru Flight_Bundle It [Tier 3]_Standard_1co 1 cb_Any free Seat_No Extras CI Web_Credit Card
...
public class TC281166 extends BaseClass {
    @Parameters({"platform"})
    @Test (groups = {"BookPath" , "RoundTrip" , "DomesticDomestic" , "Outside21Days" , "Child" , "Guest" , "Through" , "BundleIt" ,
                     "DynamicShoppingCartUI" , "CarryOn" , "CheckedBags" , "BagsUI" , "Standard" , "SeatsUI" , "FlightFlex" ,
                     "ShortCutBoarding" , "OptionalUI" , "MasterCard","PaymentUI"})
    public void E2E_Guest_RT_DOM_0_ADT_1_UMNR_Thru_Flight_Bundle_It_Standard_1co_1_cb_Any_free_Seat_No_Extras_CI_Web_Credit_Card(@Optional("NA") String platform) {
        /******************************************************************************
         ***************************Navigate to Confirmation Page**********************
         ******************************************************************************/
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC281166 under REGRESSION-CRITICAL Suite on " + platform + " Browser"   , true);
        }
