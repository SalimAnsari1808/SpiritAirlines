...
//**********************************************************************************************
//Test Case ID: TC90903
//Description: CP_CI_Online Check In page full validation_Add Hearing Disability
//Created By: Kartik chauhan
//Created On: 18-July-2019
//Reviewed By: Salim Ansari
//Reviewed On: 19-July-2019
//**********************************************************************************************
public class TC90903 extends BaseClass {
    @Parameters({"platform"})
    @Test(groups = {"CheckIn","RoundTrip","DomesticDomestic","WithIn7Days","Adult","Connecting","BookIt","NoBags","NoSeats",
                    "CheckInOptions","TravelInsurancePopUp","MasterCard","AddEditSSR","BoardingPassUI","HazmatUI"})
    public void CP_CI_Online_Check_In_page_full_validation_Add_Hearing_Disability(@Optional("NA") String platform) {
        //**************************Navigate to Payment Page***************************/
        //Mention Suite and Browser in reports
        if(!platform.equals("NA")) {
            ValidationUtil.validateTestStep("Starting Test Case ID TC90903 under REGRESSION-CRITICAL Suite on " + platform + " Browser"   , true);
        }
...
//        final String TRAVEL_GUARD       = "Required";
        ...
        final String SSR_VALUE          = "HearingImpaired";
